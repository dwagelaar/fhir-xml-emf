...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>All Resource Types Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.emf.fhir.FhirPackage#getAllResourceTypesEnum()
 * @model extendedMetaData="name='AllResourceTypesEnum'"
 * @generated
 */
public enum AllResourceTypesEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>All Resource Types Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final AllResourceTypesEnum[] VALUES_ARRAY =
		new AllResourceTypesEnum[] {
			ACCOUNT,
			ACTIVITY_DEFINITION,
			ACTOR_DEFINITION,
	...
	/**
	 * A public read-only list of all the '<em><b>All Resource Types Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<AllResourceTypesEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>All Resource Types Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static AllResourceTypesEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AllResourceTypesEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>All Resource Types Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static AllResourceTypesEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AllResourceTypesEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>All Resource Types Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static AllResourceTypesEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private AllResourceTypesEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
