 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getLinkId <em>Link Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getTextEquivalent <em>Text Equivalent</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getGoalId <em>Goal Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getSubjectCodeableConcept <em>Subject Codeable Concept</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getSubjectReference <em>Subject Reference</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getSubjectCanonical <em>Subject Canonical</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getInput <em>Input</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getRelatedAction <em>Related Action</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getTimingAge <em>Timing Age</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getTimingDuration <em>Timing Duration</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getTimingRange <em>Timing Range</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getTimingTiming <em>Timing Timing</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getParticipant <em>Participant</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getGroupingBehavior <em>Grouping Behavior</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getSelectionBehavior <em>Selection Behavior</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getRequiredBehavior <em>Required Behavior</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getPrecheckBehavior <em>Precheck Behavior</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getCardinalityBehavior <em>Cardinality Behavior</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getDefinitionCanonical <em>Definition Canonical</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getDefinitionUri <em>Definition Uri</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getDynamicValue <em>Dynamic Value</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PlanDefinitionActionImpl#getAction <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlanDefinitionActionImpl extends BackboneElementImpl implements PlanDefinitionAction {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String prefix;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getPrefix() {
		return prefix;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPrefix(org.hl7.emf.fhir.String newPrefix, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldPrefix = prefix;
		prefix = newPrefix;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setPrefix(org.hl7.emf.fhir.String newPrefix) {
		if (newPrefix != prefix) {
			NotificationChain msgs = null;
			if (prefix != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.PLAN_DEFINITION_ACTION__LINK_ID:
				...
				return;
			case FhirPackage.PLAN_DEFINITION_ACTION__PREFIX:
				setPrefix((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.PLAN_DEFINITION_ACTION__TITLE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.PLAN_DEFINITION_ACTION__LINK_ID:
				...
				return;
			case FhirPackage.PLAN_DEFINITION_ACTION__PREFIX:
				setPrefix((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.PLAN_DEFINITION_ACTION__TITLE:
