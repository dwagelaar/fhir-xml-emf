 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getBasedOn <em>Based On</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getOccurrenceDateTime <em>Occurrence Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getOccurrencePeriod <em>Occurrence Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getBasis <em>Basis</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getPrediction <em>Prediction</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getMitigation <em>Mitigation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.RiskAssessmentImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RiskAssessmentImpl extends DomainResourceImpl implements RiskAssessment {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String mitigation;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getMitigation() {
		return mitigation;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMitigation(org.hl7.emf.fhir.String newMitigation, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldMitigation = mitigation;
	 ...
	 */
	@Override
	public void setMitigation(org.hl7.emf.fhir.String newMitigation) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.RISK_ASSESSMENT__PREDICTION:
				...
				return;
			case FhirPackage.RISK_ASSESSMENT__MITIGATION:
				setMitigation((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.RISK_ASSESSMENT__NOTE:
				getNote().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.RISK_ASSESSMENT__PREDICTION:
				...
				return;
			case FhirPackage.RISK_ASSESSMENT__MITIGATION:
				setMitigation((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.RISK_ASSESSMENT__NOTE:
				getNote().clear();
				return;
