 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.BundleLinkImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.BundleLinkImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BundleLinkImpl extends BackboneElementImpl implements BundleLink {
	 ...
	 * @ordered
	 */
	protected LinkRelationTypes relation;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRelation(LinkRelationTypes newRelation, NotificationChain msgs) {
		LinkRelationTypes oldRelation = relation;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.BUNDLE_LINK__RELATION:
				setRelation((LinkRelationTypes)newValue);
				return;
			case FhirPackage.BUNDLE_LINK__URL:
				setUrl((Uri)newValue);
				return;
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.BUNDLE_LINK__RELATION:
				setRelation((LinkRelationTypes)null);
				return;
			case FhirPackage.BUNDLE_LINK__URL:
				setUrl((Uri)null);
				return;
