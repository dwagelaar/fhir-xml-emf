 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getVersionAlgorithmString <em>Version Algorithm String</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getVersionAlgorithmCoding <em>Version Algorithm Coding</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getUseContext <em>Use Context</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getJurisdiction <em>Jurisdiction</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getCopyrightLabel <em>Copyright Label</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getInstantiates <em>Instantiates</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getSoftware <em>Software</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getFhirVersion <em>Fhir Version</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getPatchFormat <em>Patch Format</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getAcceptLanguage <em>Accept Language</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getImplementationGuide <em>Implementation Guide</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getRest <em>Rest</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getMessaging <em>Messaging</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementImpl#getDocument <em>Document</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilityStatementImpl extends CanonicalResourceImpl implements CapabilityStatement {
	/**
	...
	/**
	 * The cached value of the '{@link #getAcceptLanguage() <em>Accept Language</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<Code> acceptLanguage;
	...
	public NotificationChain basicSetVersionAlgorithmString(org.hl7.emf.fhir.String newVersionAlgorithmString, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_STRING, oldVersionAlgorithmString, newVersionAlgorithmString);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVersionAlgorithmString(org.hl7.emf.fhir.String newVersionAlgorithmString) {
		if (newVersionAlgorithmString != versionAlgorithmString) {
			...
			if (versionAlgorithmString != null)
				msgs = ((InternalEObject)versionAlgorithmString).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_STRING, null, msgs);
			if (newVersionAlgorithmString != null)
				msgs = ((InternalEObject)newVersionAlgorithmString).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_STRING, null, msgs);
			msgs = basicSetVersionAlgorithmString(newVersionAlgorithmString, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_STRING, newVersionAlgorithmString, newVersionAlgorithmString));
	}
	...
	public NotificationChain basicSetVersionAlgorithmCoding(Coding newVersionAlgorithmCoding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_CODING, oldVersionAlgorithmCoding, newVersionAlgorithmCoding);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVersionAlgorithmCoding(Coding newVersionAlgorithmCoding) {
		if (newVersionAlgorithmCoding != versionAlgorithmCoding) {
			...
			if (versionAlgorithmCoding != null)
				msgs = ((InternalEObject)versionAlgorithmCoding).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_CODING, null, msgs);
			if (newVersionAlgorithmCoding != null)
				msgs = ((InternalEObject)newVersionAlgorithmCoding).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_CODING, null, msgs);
			msgs = basicSetVersionAlgorithmCoding(newVersionAlgorithmCoding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_CODING, newVersionAlgorithmCoding, newVersionAlgorithmCoding));
	}
	...
	public NotificationChain basicSetCopyrightLabel(org.hl7.emf.fhir.String newCopyrightLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT__COPYRIGHT_LABEL, oldCopyrightLabel, newCopyrightLabel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCopyrightLabel(org.hl7.emf.fhir.String newCopyrightLabel) {
		if (newCopyrightLabel != copyrightLabel) {
			...
			if (copyrightLabel != null)
				msgs = ((InternalEObject)copyrightLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT__COPYRIGHT_LABEL, null, msgs);
			if (newCopyrightLabel != null)
				msgs = ((InternalEObject)newCopyrightLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT__COPYRIGHT_LABEL, null, msgs);
			msgs = basicSetCopyrightLabel(newCopyrightLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT__COPYRIGHT_LABEL, newCopyrightLabel, newCopyrightLabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.CAPABILITY_STATEMENT__IDENTIFIER:
				return ((InternalEList<?>)getIdentifier()).basicRemove(otherEnd, msgs);
			case FhirPackage.CAPABILITY_STATEMENT__VERSION:
				return basicSetVersion(null, msgs);
			case FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_STRING:
				return basicSetVersionAlgorithmString(null, msgs);
			case FhirPackage.CAPABILITY_STATEMENT__VERSION_ALGORITHM_CODING:
			...
			case FhirPackage.CAPABILITY_STATEMENT__COPYRIGHT_LABEL:
			...
			case FhirPackage.CAPABILITY_STATEMENT__ACCEPT_LANGUAGE:
				return ((InternalEList<?>)getAcceptLanguage()).basicRemove(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.CAPABILITY_STATEMENT__PATCH_FORMAT:
				...
				return;
			case FhirPackage.CAPABILITY_STATEMENT__ACCEPT_LANGUAGE:
				getAcceptLanguage().clear();
				getAcceptLanguage().addAll((Collection<? extends Code>)newValue);
				return;
			case FhirPackage.CAPABILITY_STATEMENT__IMPLEMENTATION_GUIDE:
