 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ImplementationGuideManifestImpl#getRendering <em>Rendering</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ImplementationGuideManifestImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ImplementationGuideManifestImpl#getPage <em>Page</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ImplementationGuideManifestImpl#getImage <em>Image</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ImplementationGuideManifestImpl#getOther <em>Other</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationGuideManifestImpl extends BackboneElementImpl implements ImplementationGuideManifest {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> image;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> other;
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getImage() {
		if (image == null) {
			image = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.IMPLEMENTATION_GUIDE_MANIFEST__IMAGE);
		}
		return image;
	}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getOther() {
		if (other == null) {
			other = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.IMPLEMENTATION_GUIDE_MANIFEST__OTHER);
		}
		return other;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.IMPLEMENTATION_GUIDE_MANIFEST__IMAGE:
				getImage().clear();
				getImage().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.IMPLEMENTATION_GUIDE_MANIFEST__OTHER:
				getOther().clear();
				getOther().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
		}
