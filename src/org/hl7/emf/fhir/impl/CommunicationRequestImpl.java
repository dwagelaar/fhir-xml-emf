 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getBasedOn <em>Based On</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getReplaces <em>Replaces</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getGroupIdentifier <em>Group Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getIntent <em>Intent</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getDoNotPerform <em>Do Not Perform</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getMedium <em>Medium</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getAbout <em>About</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getPayload <em>Payload</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getOccurrenceDateTime <em>Occurrence Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getOccurrencePeriod <em>Occurrence Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getAuthoredOn <em>Authored On</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getRequester <em>Requester</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getInformationProvider <em>Information Provider</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationRequestImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationRequestImpl extends DomainResourceImpl implements CommunicationRequest {
	...
	/**
	 * The cached value of the '{@link #getInformationProvider() <em>Information Provider</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getInformationProvider()
	 * @generated
	 * @ordered
	 */
	...
	public NotificationChain basicSetIntent(RequestIntent newIntent, NotificationChain msgs) {
		...
		intent = newIntent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_REQUEST__INTENT, oldIntent, newIntent);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIntent(RequestIntent newIntent) {
		if (newIntent != intent) {
			NotificationChain msgs = null;
			if (intent != null)
				msgs = ((InternalEObject)intent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_REQUEST__INTENT, null, msgs);
			if (newIntent != null)
				msgs = ((InternalEObject)newIntent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_REQUEST__INTENT, null, msgs);
			msgs = basicSetIntent(newIntent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_REQUEST__INTENT, newIntent, newIntent));
	}
	...
	public EList<Reference> getInformationProvider() {
		if (informationProvider == null) {
			informationProvider = new EObjectContainmentEList<Reference>(Reference.class, this, FhirPackage.COMMUNICATION_REQUEST__INFORMATION_PROVIDER);
		}
	...
	public EList<CodeableReference> getReason() {
		if (reason == null) {
			reason = new EObjectContainmentEList<CodeableReference>(CodeableReference.class, this, FhirPackage.COMMUNICATION_REQUEST__REASON);
		}
		return reason;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.COMMUNICATION_REQUEST__INTENT:
			...
			case FhirPackage.COMMUNICATION_REQUEST__INFORMATION_PROVIDER:
				return ((InternalEList<?>)getInformationProvider()).basicRemove(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.COMMUNICATION_REQUEST__INFORMATION_PROVIDER:
				...
				getInformationProvider().addAll((Collection<? extends Reference>)newValue);
				return;
			case FhirPackage.COMMUNICATION_REQUEST__REASON:
				getReason().clear();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.COMMUNICATION_REQUEST__INFORMATION_PROVIDER:
				return informationProvider != null && !informationProvider.isEmpty();
			case FhirPackage.COMMUNICATION_REQUEST__REASON:
