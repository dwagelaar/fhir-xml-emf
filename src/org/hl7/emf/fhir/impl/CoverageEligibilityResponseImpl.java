 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getServicedDate <em>Serviced Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getServicedPeriod <em>Serviced Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getRequestor <em>Requestor</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getInsurer <em>Insurer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getInsurance <em>Insurance</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getPreAuthRef <em>Pre Auth Ref</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getForm <em>Form</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityResponseImpl#getError <em>Error</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CoverageEligibilityResponseImpl extends DomainResourceImpl implements CoverageEligibilityResponse {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOutcome(EligibilityOutcome newOutcome, NotificationChain msgs) {
		EligibilityOutcome oldOutcome = outcome;
		outcome = newOutcome;
		if (eNotificationRequired()) {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.COVERAGE_ELIGIBILITY_RESPONSE__EVENT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.COVERAGE_ELIGIBILITY_RESPONSE__EVENT:
				getEvent().clear();
				getEvent().addAll((Collection<? extends CoverageEligibilityResponseEvent>)newValue);
				return;
			case FhirPackage.COVERAGE_ELIGIBILITY_RESPONSE__SERVICED_DATE:
			...
			case FhirPackage.COVERAGE_ELIGIBILITY_RESPONSE__REQUEST:
				...
				return;
			case FhirPackage.COVERAGE_ELIGIBILITY_RESPONSE__OUTCOME:
				setOutcome((EligibilityOutcome)newValue);
				return;
			case FhirPackage.COVERAGE_ELIGIBILITY_RESPONSE__DISPOSITION:
