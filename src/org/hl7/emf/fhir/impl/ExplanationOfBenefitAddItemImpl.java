 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getItemSequence <em>Item Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getDetailSequence <em>Detail Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getSubDetailSequence <em>Sub Detail Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getTraceNumber <em>Trace Number</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getRevenue <em>Revenue</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getProductOrService <em>Product Or Service</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getProductOrServiceEnd <em>Product Or Service End</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getModifier <em>Modifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getProgramCode <em>Program Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getServicedDate <em>Serviced Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getServicedPeriod <em>Serviced Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getLocationCodeableConcept <em>Location Codeable Concept</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getLocationAddress <em>Location Address</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getLocationReference <em>Location Reference</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getPatientPaid <em>Patient Paid</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getTax <em>Tax</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getNet <em>Net</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getNoteNumber <em>Note Number</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getReviewOutcome <em>Review Outcome</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getAdjudication <em>Adjudication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitAddItemImpl#getDetail <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplanationOfBenefitAddItemImpl extends BackboneElementImpl implements ExplanationOfBenefitAddItem {
	 ...
	 * @ordered
	 */
	protected EList<ExplanationOfBenefitBodySite1> bodySite;
	...
	public EList<Identifier> getTraceNumber() {
		if (traceNumber == null) {
			traceNumber = new EObjectContainmentEList<Identifier>(Identifier.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__TRACE_NUMBER);
		}
		return traceNumber;
	}
	...
	public NotificationChain basicSetProductOrServiceEnd(CodeableConcept newProductOrServiceEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PRODUCT_OR_SERVICE_END, oldProductOrServiceEnd, newProductOrServiceEnd);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProductOrServiceEnd(CodeableConcept newProductOrServiceEnd) {
		if (newProductOrServiceEnd != productOrServiceEnd) {
			...
			if (productOrServiceEnd != null)
				msgs = ((InternalEObject)productOrServiceEnd).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PRODUCT_OR_SERVICE_END, null, msgs);
			if (newProductOrServiceEnd != null)
				msgs = ((InternalEObject)newProductOrServiceEnd).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PRODUCT_OR_SERVICE_END, null, msgs);
			msgs = basicSetProductOrServiceEnd(newProductOrServiceEnd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PRODUCT_OR_SERVICE_END, newProductOrServiceEnd, newProductOrServiceEnd));
	}
	...
	public EList<Reference> getRequest() {
		if (request == null) {
			request = new EObjectContainmentEList<Reference>(Reference.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__REQUEST);
		}
		return request;
	}
	...
	public NotificationChain basicSetPatientPaid(Money newPatientPaid, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PATIENT_PAID, oldPatientPaid, newPatientPaid);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPatientPaid(Money newPatientPaid) {
		if (newPatientPaid != patientPaid) {
			NotificationChain msgs = null;
			if (patientPaid != null)
				msgs = ((InternalEObject)patientPaid).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PATIENT_PAID, null, msgs);
			if (newPatientPaid != null)
				msgs = ((InternalEObject)newPatientPaid).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PATIENT_PAID, null, msgs);
			msgs = basicSetPatientPaid(newPatientPaid, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PATIENT_PAID, newPatientPaid, newPatientPaid));
	}
	...
	public NotificationChain basicSetTax(Money newTax, NotificationChain msgs) {
		...
		tax = newTax;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__TAX, oldTax, newTax);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTax(Money newTax) {
		if (newTax != tax) {
			NotificationChain msgs = null;
			if (tax != null)
				msgs = ((InternalEObject)tax).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__TAX, null, msgs);
			if (newTax != null)
				msgs = ((InternalEObject)newTax).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__TAX, null, msgs);
			msgs = basicSetTax(newTax, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__TAX, newTax, newTax));
	}
	 ...
	 */
	@Override
	public EList<ExplanationOfBenefitBodySite1> getBodySite() {
		if (bodySite == null) {
			bodySite = new EObjectContainmentEList<ExplanationOfBenefitBodySite1>(ExplanationOfBenefitBodySite1.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__BODY_SITE);
		}
		return bodySite;
	}
	...
	public NotificationChain basicSetReviewOutcome(ExplanationOfBenefitReviewOutcome newReviewOutcome, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__REVIEW_OUTCOME, oldReviewOutcome, newReviewOutcome);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReviewOutcome(ExplanationOfBenefitReviewOutcome newReviewOutcome) {
		if (newReviewOutcome != reviewOutcome) {
			...
			if (reviewOutcome != null)
				msgs = ((InternalEObject)reviewOutcome).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__REVIEW_OUTCOME, null, msgs);
			if (newReviewOutcome != null)
				msgs = ((InternalEObject)newReviewOutcome).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__REVIEW_OUTCOME, null, msgs);
			msgs = basicSetReviewOutcome(newReviewOutcome, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__REVIEW_OUTCOME, newReviewOutcome, newReviewOutcome));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__TRACE_NUMBER:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PRODUCT_OR_SERVICE_END:
				return basicSetProductOrServiceEnd(null, msgs);
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__REQUEST:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__PATIENT_PAID:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__TAX:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__REVIEW_OUTCOME:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__BODY_SITE:
				getBodySite().clear();
				getBodySite().addAll((Collection<? extends ExplanationOfBenefitBodySite1>)newValue);
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT_ADD_ITEM__NOTE_NUMBER:
				getNoteNumber().clear();
