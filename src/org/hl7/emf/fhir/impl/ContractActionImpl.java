 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getDoNotPerform <em>Do Not Perform</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getIntent <em>Intent</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getLinkId <em>Link Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getContext <em>Context</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getContextLinkId <em>Context Link Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getOccurrenceDateTime <em>Occurrence Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getOccurrencePeriod <em>Occurrence Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getOccurrenceTiming <em>Occurrence Timing</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getRequester <em>Requester</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getRequesterLinkId <em>Requester Link Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getPerformerType <em>Performer Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getPerformerRole <em>Performer Role</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getPerformerLinkId <em>Performer Link Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getReasonLinkId <em>Reason Link Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getNote <em>Note</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ContractActionImpl#getSecurityLabelNumber <em>Security Label Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractActionImpl extends BackboneElementImpl implements ContractAction {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> linkId;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> contextLinkId;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> requesterLinkId;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> performerLinkId;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> reasonLinkId;
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getLinkId() {
		if (linkId == null) {
			linkId = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.CONTRACT_ACTION__LINK_ID);
		}
		return linkId;
	}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getContextLinkId() {
		if (contextLinkId == null) {
			contextLinkId = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.CONTRACT_ACTION__CONTEXT_LINK_ID);
		}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getRequesterLinkId() {
		if (requesterLinkId == null) {
			requesterLinkId = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.CONTRACT_ACTION__REQUESTER_LINK_ID);
		}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getPerformerLinkId() {
		if (performerLinkId == null) {
			performerLinkId = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.CONTRACT_ACTION__PERFORMER_LINK_ID);
		}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getReasonLinkId() {
		if (reasonLinkId == null) {
			reasonLinkId = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.CONTRACT_ACTION__REASON_LINK_ID);
		}
		return reasonLinkId;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.CONTRACT_ACTION__LINK_ID:
				getLinkId().clear();
				getLinkId().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.CONTRACT_ACTION__STATUS:
			...
			case FhirPackage.CONTRACT_ACTION__CONTEXT_LINK_ID:
				...
				getContextLinkId().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.CONTRACT_ACTION__OCCURRENCE_DATE_TIME:
			...
			case FhirPackage.CONTRACT_ACTION__REQUESTER_LINK_ID:
				...
				getRequesterLinkId().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.CONTRACT_ACTION__PERFORMER_TYPE:
			...
			case FhirPackage.CONTRACT_ACTION__PERFORMER_LINK_ID:
				...
				getPerformerLinkId().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.CONTRACT_ACTION__REASON:
				getReason().clear();
			...
			case FhirPackage.CONTRACT_ACTION__REASON_LINK_ID:
				...
				getReasonLinkId().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.CONTRACT_ACTION__NOTE:
				getNote().clear();
