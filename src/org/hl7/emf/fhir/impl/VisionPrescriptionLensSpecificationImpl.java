 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getEye <em>Eye</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getSphere <em>Sphere</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getCylinder <em>Cylinder</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getAxis <em>Axis</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getPrism <em>Prism</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getAdd <em>Add</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getPower <em>Power</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getBackCurve <em>Back Curve</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getDiameter <em>Diameter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getColor <em>Color</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getBrand <em>Brand</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VisionPrescriptionLensSpecificationImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VisionPrescriptionLensSpecificationImpl extends BackboneElementImpl implements VisionPrescriptionLensSpecification {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer axis;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String color;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String brand;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getAxis() {
		return axis;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAxis(org.hl7.emf.fhir.Integer newAxis, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldAxis = axis;
		axis = newAxis;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setAxis(org.hl7.emf.fhir.Integer newAxis) {
		if (newAxis != axis) {
			NotificationChain msgs = null;
			if (axis != null)
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getColor() {
		return color;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetColor(org.hl7.emf.fhir.String newColor, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldColor = color;
		color = newColor;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setColor(org.hl7.emf.fhir.String newColor) {
		if (newColor != color) {
			NotificationChain msgs = null;
			if (color != null)
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getBrand() {
		return brand;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBrand(org.hl7.emf.fhir.String newBrand, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldBrand = brand;
		brand = newBrand;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setBrand(org.hl7.emf.fhir.String newBrand) {
		if (newBrand != brand) {
			NotificationChain msgs = null;
			if (brand != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__CYLINDER:
				...
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__AXIS:
				setAxis((org.hl7.emf.fhir.Integer)newValue);
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__PRISM:
				getPrism().clear();
			...
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__DURATION:
				...
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__COLOR:
				setColor((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__BRAND:
				setBrand((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__NOTE:
				getNote().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__CYLINDER:
				...
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__AXIS:
				setAxis((org.hl7.emf.fhir.Integer)null);
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__PRISM:
				getPrism().clear();
				return;
			...
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__DURATION:
				...
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__COLOR:
				setColor((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__BRAND:
				setBrand((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.VISION_PRESCRIPTION_LENS_SPECIFICATION__NOTE:
				getNote().clear();
				return;
