 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ProcedurePerformerImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ProcedurePerformerImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ProcedurePerformerImpl#getOnBehalfOf <em>On Behalf Of</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ProcedurePerformerImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcedurePerformerImpl extends BackboneElementImpl implements ProcedurePerformer {
	...
	public NotificationChain basicSetPeriod(Period newPeriod, NotificationChain msgs) {
		...
		period = newPeriod;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PROCEDURE_PERFORMER__PERIOD, oldPeriod, newPeriod);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPeriod(Period newPeriod) {
		if (newPeriod != period) {
			NotificationChain msgs = null;
			if (period != null)
				msgs = ((InternalEObject)period).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PROCEDURE_PERFORMER__PERIOD, null, msgs);
			if (newPeriod != null)
				msgs = ((InternalEObject)newPeriod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PROCEDURE_PERFORMER__PERIOD, null, msgs);
			msgs = basicSetPeriod(newPeriod, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PROCEDURE_PERFORMER__PERIOD, newPeriod, newPeriod));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.PROCEDURE_PERFORMER__PERIOD:
