 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getTimingDate <em>Timing Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getTimingPeriod <em>Timing Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getValueBoolean <em>Value Boolean</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getValueString <em>Value String</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getValueQuantity <em>Value Quantity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getValueAttachment <em>Value Attachment</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getValueReference <em>Value Reference</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getValueIdentifier <em>Value Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimSupportingInfoImpl#getReason <em>Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimSupportingInfoImpl extends BackboneElementImpl implements ClaimSupportingInfo {
	...
	public NotificationChain basicSetValueIdentifier(Identifier newValueIdentifier, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_SUPPORTING_INFO__VALUE_IDENTIFIER, oldValueIdentifier, newValueIdentifier);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueIdentifier(Identifier newValueIdentifier) {
		if (newValueIdentifier != valueIdentifier) {
			...
			if (valueIdentifier != null)
				msgs = ((InternalEObject)valueIdentifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_SUPPORTING_INFO__VALUE_IDENTIFIER, null, msgs);
			if (newValueIdentifier != null)
				msgs = ((InternalEObject)newValueIdentifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_SUPPORTING_INFO__VALUE_IDENTIFIER, null, msgs);
			msgs = basicSetValueIdentifier(newValueIdentifier, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_SUPPORTING_INFO__VALUE_IDENTIFIER, newValueIdentifier, newValueIdentifier));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.CLAIM_SUPPORTING_INFO__VALUE_IDENTIFIER:
