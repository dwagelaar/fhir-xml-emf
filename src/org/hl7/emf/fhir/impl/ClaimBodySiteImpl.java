...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Claim Body Site</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimBodySiteImpl#getSite <em>Site</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimBodySiteImpl#getSubSite <em>Sub Site</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimBodySiteImpl extends BackboneElementImpl implements ClaimBodySite {
	/**
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getClaimBodySite();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.CLAIM_BODY_SITE__SITE:
				return ((InternalEList<?>)getSite()).basicRemove(otherEnd, msgs);
			case FhirPackage.CLAIM_BODY_SITE__SUB_SITE:
