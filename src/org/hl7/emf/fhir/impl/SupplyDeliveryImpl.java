 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getBasedOn <em>Based On</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getPartOf <em>Part Of</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getSuppliedItem <em>Supplied Item</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getOccurrenceDateTime <em>Occurrence Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getOccurrencePeriod <em>Occurrence Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getOccurrenceTiming <em>Occurrence Timing</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SupplyDeliveryImpl#getReceiver <em>Receiver</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupplyDeliveryImpl extends DomainResourceImpl implements SupplyDelivery {
	...
	/**
	 * The cached value of the '{@link #getSuppliedItem() <em>Supplied Item</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSuppliedItem()
	 * @generated
	...
	public EList<SupplyDeliverySuppliedItem> getSuppliedItem() {
		if (suppliedItem == null) {
			suppliedItem = new EObjectContainmentEList<SupplyDeliverySuppliedItem>(SupplyDeliverySuppliedItem.class, this, FhirPackage.SUPPLY_DELIVERY__SUPPLIED_ITEM);
		}
		return suppliedItem;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.SUPPLY_DELIVERY__SUPPLIED_ITEM:
				return ((InternalEList<?>)getSuppliedItem()).basicRemove(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SUPPLY_DELIVERY__SUPPLIED_ITEM:
				...
				getSuppliedItem().addAll((Collection<? extends SupplyDeliverySuppliedItem>)newValue);
				return;
			case FhirPackage.SUPPLY_DELIVERY__OCCURRENCE_DATE_TIME:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.SUPPLY_DELIVERY__TYPE:
				return type != null;
			case FhirPackage.SUPPLY_DELIVERY__SUPPLIED_ITEM:
				return suppliedItem != null && !suppliedItem.isEmpty();
			case FhirPackage.SUPPLY_DELIVERY__OCCURRENCE_DATE_TIME:
