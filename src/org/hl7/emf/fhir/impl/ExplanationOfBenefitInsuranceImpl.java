 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitInsuranceImpl#getFocal <em>Focal</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitInsuranceImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitInsuranceImpl#getPreAuthRef <em>Pre Auth Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplanationOfBenefitInsuranceImpl extends BackboneElementImpl implements ExplanationOfBenefitInsurance {
	...
	public EList<org.hl7.emf.fhir.String> getPreAuthRef() {
		if (preAuthRef == null) {
			preAuthRef = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_INSURANCE__PRE_AUTH_REF);
		}
		return preAuthRef;
	}
