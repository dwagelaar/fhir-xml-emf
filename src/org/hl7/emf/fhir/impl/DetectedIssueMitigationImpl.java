 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.DetectedIssueMitigationImpl#getAction <em>Action</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DetectedIssueMitigationImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DetectedIssueMitigationImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DetectedIssueMitigationImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DetectedIssueMitigationImpl extends BackboneElementImpl implements DetectedIssueMitigation {
	...
	public EList<Annotation> getNote() {
		if (note == null) {
			note = new EObjectContainmentEList<Annotation>(Annotation.class, this, FhirPackage.DETECTED_ISSUE_MITIGATION__NOTE);
		}
		return note;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.DETECTED_ISSUE_MITIGATION__NOTE:
