 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getRequestIdentifier <em>Request Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getModuleUri <em>Module Uri</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getModuleCanonical <em>Module Canonical</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getModuleCodeableConcept <em>Module Codeable Concept</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getOccurrenceDateTime <em>Occurrence Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getNote <em>Note</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getEvaluationMessage <em>Evaluation Message</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getOutputParameters <em>Output Parameters</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getResult <em>Result</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.GuidanceResponseImpl#getDataRequirement <em>Data Requirement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuidanceResponseImpl extends DomainResourceImpl implements GuidanceResponse {
	...
	/**
	 * The cached value of the '{@link #getEvaluationMessage() <em>Evaluation Message</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<CodeableReference> getReason() {
		if (reason == null) {
			reason = new EObjectContainmentEList<CodeableReference>(CodeableReference.class, this, FhirPackage.GUIDANCE_RESPONSE__REASON);
		}
		return reason;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEvaluationMessage(Reference newEvaluationMessage, NotificationChain msgs) {
		Reference oldEvaluationMessage = evaluationMessage;
		evaluationMessage = newEvaluationMessage;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.GUIDANCE_RESPONSE__EVALUATION_MESSAGE, oldEvaluationMessage, newEvaluationMessage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 */
	@Override
	public void setEvaluationMessage(Reference newEvaluationMessage) {
		if (newEvaluationMessage != evaluationMessage) {
			NotificationChain msgs = null;
			if (evaluationMessage != null)
				msgs = ((InternalEObject)evaluationMessage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.GUIDANCE_RESPONSE__EVALUATION_MESSAGE, null, msgs);
			if (newEvaluationMessage != null)
				msgs = ((InternalEObject)newEvaluationMessage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.GUIDANCE_RESPONSE__EVALUATION_MESSAGE, null, msgs);
			msgs = basicSetEvaluationMessage(newEvaluationMessage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.GUIDANCE_RESPONSE__EVALUATION_MESSAGE, newEvaluationMessage, newEvaluationMessage));
	}
	...
	public EList<Reference> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<Reference>(Reference.class, this, FhirPackage.GUIDANCE_RESPONSE__RESULT);
		}
		return result;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.GUIDANCE_RESPONSE__REASON:
			...
			case FhirPackage.GUIDANCE_RESPONSE__EVALUATION_MESSAGE:
				return basicSetEvaluationMessage(null, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.GUIDANCE_RESPONSE__NOTE:
				...
				return;
			case FhirPackage.GUIDANCE_RESPONSE__EVALUATION_MESSAGE:
				setEvaluationMessage((Reference)newValue);
				return;
			case FhirPackage.GUIDANCE_RESPONSE__OUTPUT_PARAMETERS:
