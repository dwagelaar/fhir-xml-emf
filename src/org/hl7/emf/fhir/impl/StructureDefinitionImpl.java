 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getVersionAlgorithmString <em>Version Algorithm String</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getVersionAlgorithmCoding <em>Version Algorithm Coding</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getExperimental <em>Experimental</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getUseContext <em>Use Context</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getJurisdiction <em>Jurisdiction</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getCopyrightLabel <em>Copyright Label</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getKeyword <em>Keyword</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getFhirVersion <em>Fhir Version</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getMapping <em>Mapping</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getContext <em>Context</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getContextInvariant <em>Context Invariant</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getBaseDefinition <em>Base Definition</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getDerivation <em>Derivation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getSnapshot <em>Snapshot</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureDefinitionImpl#getDifferential <em>Differential</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureDefinitionImpl extends CanonicalResourceImpl implements StructureDefinition {
	/**
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean abstract_;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> contextInvariant;
	...
	public NotificationChain basicSetVersionAlgorithmString(org.hl7.emf.fhir.String newVersionAlgorithmString, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_STRING, oldVersionAlgorithmString, newVersionAlgorithmString);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVersionAlgorithmString(org.hl7.emf.fhir.String newVersionAlgorithmString) {
		if (newVersionAlgorithmString != versionAlgorithmString) {
			...
			if (versionAlgorithmString != null)
				msgs = ((InternalEObject)versionAlgorithmString).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_STRING, null, msgs);
			if (newVersionAlgorithmString != null)
				msgs = ((InternalEObject)newVersionAlgorithmString).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_STRING, null, msgs);
			msgs = basicSetVersionAlgorithmString(newVersionAlgorithmString, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_STRING, newVersionAlgorithmString, newVersionAlgorithmString));
	}
	...
	public NotificationChain basicSetVersionAlgorithmCoding(Coding newVersionAlgorithmCoding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_CODING, oldVersionAlgorithmCoding, newVersionAlgorithmCoding);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVersionAlgorithmCoding(Coding newVersionAlgorithmCoding) {
		if (newVersionAlgorithmCoding != versionAlgorithmCoding) {
			...
			if (versionAlgorithmCoding != null)
				msgs = ((InternalEObject)versionAlgorithmCoding).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_CODING, null, msgs);
			if (newVersionAlgorithmCoding != null)
				msgs = ((InternalEObject)newVersionAlgorithmCoding).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_CODING, null, msgs);
			msgs = basicSetVersionAlgorithmCoding(newVersionAlgorithmCoding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_CODING, newVersionAlgorithmCoding, newVersionAlgorithmCoding));
	}
	...
	public NotificationChain basicSetCopyrightLabel(org.hl7.emf.fhir.String newCopyrightLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.STRUCTURE_DEFINITION__COPYRIGHT_LABEL, oldCopyrightLabel, newCopyrightLabel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCopyrightLabel(org.hl7.emf.fhir.String newCopyrightLabel) {
		if (newCopyrightLabel != copyrightLabel) {
			...
			if (copyrightLabel != null)
				msgs = ((InternalEObject)copyrightLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.STRUCTURE_DEFINITION__COPYRIGHT_LABEL, null, msgs);
			if (newCopyrightLabel != null)
				msgs = ((InternalEObject)newCopyrightLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.STRUCTURE_DEFINITION__COPYRIGHT_LABEL, null, msgs);
			msgs = basicSetCopyrightLabel(newCopyrightLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.STRUCTURE_DEFINITION__COPYRIGHT_LABEL, newCopyrightLabel, newCopyrightLabel));
	}
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getAbstract() {
		return abstract_;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAbstract(org.hl7.emf.fhir.Boolean newAbstract, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldAbstract = abstract_;
	 ...
	 */
	@Override
	public void setAbstract(org.hl7.emf.fhir.Boolean newAbstract) {
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getContextInvariant() {
		if (contextInvariant == null) {
			contextInvariant = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.STRUCTURE_DEFINITION__CONTEXT_INVARIANT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_STRING:
				return basicSetVersionAlgorithmString(null, msgs);
			case FhirPackage.STRUCTURE_DEFINITION__VERSION_ALGORITHM_CODING:
			...
			case FhirPackage.STRUCTURE_DEFINITION__COPYRIGHT_LABEL:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.STRUCTURE_DEFINITION__KIND:
				...
				return;
			case FhirPackage.STRUCTURE_DEFINITION__ABSTRACT:
				setAbstract((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.STRUCTURE_DEFINITION__CONTEXT:
				getContext().clear();
			...
			case FhirPackage.STRUCTURE_DEFINITION__CONTEXT_INVARIANT:
				...
				getContextInvariant().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.STRUCTURE_DEFINITION__TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.STRUCTURE_DEFINITION__KIND:
				...
				return;
			case FhirPackage.STRUCTURE_DEFINITION__ABSTRACT:
				setAbstract((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.STRUCTURE_DEFINITION__CONTEXT:
				getContext().clear();
				return;
