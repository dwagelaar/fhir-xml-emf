 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseErrorImpl#getItemSequence <em>Item Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseErrorImpl#getDetailSequence <em>Detail Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseErrorImpl#getSubDetailSequence <em>Sub Detail Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseErrorImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseErrorImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimResponseErrorImpl extends BackboneElementImpl implements ClaimResponseError {
	...
	public EList<org.hl7.emf.fhir.String> getExpression() {
		if (expression == null) {
			expression = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.CLAIM_RESPONSE_ERROR__EXPRESSION);
		}
		return expression;
	}
