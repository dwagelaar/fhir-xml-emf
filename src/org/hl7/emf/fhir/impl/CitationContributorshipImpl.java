 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.CitationContributorshipImpl#getComplete <em>Complete</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CitationContributorshipImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CitationContributorshipImpl#getSummary <em>Summary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CitationContributorshipImpl extends BackboneElementImpl implements CitationContributorship {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean complete;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getComplete() {
		return complete;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetComplete(org.hl7.emf.fhir.Boolean newComplete, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldComplete = complete;
	 ...
	 */
	@Override
	public void setComplete(org.hl7.emf.fhir.Boolean newComplete) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.CITATION_CONTRIBUTORSHIP__COMPLETE:
				setComplete((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.CITATION_CONTRIBUTORSHIP__ENTRY:
				getEntry().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.CITATION_CONTRIBUTORSHIP__COMPLETE:
				setComplete((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.CITATION_CONTRIBUTORSHIP__ENTRY:
				getEntry().clear();
				return;
