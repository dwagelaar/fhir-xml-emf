 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getMaterial <em>Material</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getCap <em>Cap</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getMinimumVolumeQuantity <em>Minimum Volume Quantity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getMinimumVolumeString <em>Minimum Volume String</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getAdditive <em>Additive</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionContainerImpl#getPreparation <em>Preparation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecimenDefinitionContainerImpl extends BackboneElementImpl implements SpecimenDefinitionContainer {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String minimumVolumeString;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getMinimumVolumeString() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMinimumVolumeString(org.hl7.emf.fhir.String newMinimumVolumeString, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldMinimumVolumeString = minimumVolumeString;
	 ...
	 */
	@Override
	public void setMinimumVolumeString(org.hl7.emf.fhir.String newMinimumVolumeString) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPreparation(Markdown newPreparation, NotificationChain msgs) {
		Markdown oldPreparation = preparation;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SPECIMEN_DEFINITION_CONTAINER__MINIMUM_VOLUME_QUANTITY:
				...
				return;
			case FhirPackage.SPECIMEN_DEFINITION_CONTAINER__MINIMUM_VOLUME_STRING:
				setMinimumVolumeString((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.SPECIMEN_DEFINITION_CONTAINER__ADDITIVE:
				getAdditive().clear();
				...
				return;
			case FhirPackage.SPECIMEN_DEFINITION_CONTAINER__PREPARATION:
				setPreparation((Markdown)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.SPECIMEN_DEFINITION_CONTAINER__MINIMUM_VOLUME_QUANTITY:
				...
				return;
			case FhirPackage.SPECIMEN_DEFINITION_CONTAINER__MINIMUM_VOLUME_STRING:
				setMinimumVolumeString((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.SPECIMEN_DEFINITION_CONTAINER__ADDITIVE:
				getAdditive().clear();
				return;
