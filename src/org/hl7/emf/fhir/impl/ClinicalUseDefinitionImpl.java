 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getContraindication <em>Contraindication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getIndication <em>Indication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getPopulation <em>Population</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getLibrary <em>Library</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getUndesirableEffect <em>Undesirable Effect</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalUseDefinitionImpl#getWarning <em>Warning</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClinicalUseDefinitionImpl extends DomainResourceImpl implements ClinicalUseDefinition {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.CLINICAL_USE_DEFINITION__LIBRARY:
