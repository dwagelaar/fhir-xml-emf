 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceSourceMaterialOrganismImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceSourceMaterialOrganismImpl#getGenus <em>Genus</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceSourceMaterialOrganismImpl#getSpecies <em>Species</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceSourceMaterialOrganismImpl#getIntraspecificType <em>Intraspecific Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceSourceMaterialOrganismImpl#getIntraspecificDescription <em>Intraspecific Description</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceSourceMaterialOrganismImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceSourceMaterialOrganismImpl#getHybrid <em>Hybrid</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceSourceMaterialOrganismImpl#getOrganismGeneral <em>Organism General</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstanceSourceMaterialOrganismImpl extends BackboneElementImpl implements SubstanceSourceMaterialOrganism {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String intraspecificDescription;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getIntraspecificDescription() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIntraspecificDescription(org.hl7.emf.fhir.String newIntraspecificDescription, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldIntraspecificDescription = intraspecificDescription;
	 ...
	 */
	@Override
	public void setIntraspecificDescription(org.hl7.emf.fhir.String newIntraspecificDescription) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM__INTRASPECIFIC_TYPE:
				...
				return;
			case FhirPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM__INTRASPECIFIC_DESCRIPTION:
				setIntraspecificDescription((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM__AUTHOR:
				getAuthor().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM__INTRASPECIFIC_TYPE:
				...
				return;
			case FhirPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM__INTRASPECIFIC_DESCRIPTION:
				setIntraspecificDescription((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.SUBSTANCE_SOURCE_MATERIAL_ORGANISM__AUTHOR:
				getAuthor().clear();
				return;
