 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SubscriptionTopicNotificationShapeImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubscriptionTopicNotificationShapeImpl#getInclude <em>Include</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubscriptionTopicNotificationShapeImpl#getRevInclude <em>Rev Include</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubscriptionTopicNotificationShapeImpl extends BackboneElementImpl implements SubscriptionTopicNotificationShape {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> include;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> revInclude;
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getInclude() {
		if (include == null) {
			include = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.SUBSCRIPTION_TOPIC_NOTIFICATION_SHAPE__INCLUDE);
		}
		return include;
	}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getRevInclude() {
		if (revInclude == null) {
			revInclude = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.SUBSCRIPTION_TOPIC_NOTIFICATION_SHAPE__REV_INCLUDE);
		}
		return revInclude;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SUBSCRIPTION_TOPIC_NOTIFICATION_SHAPE__INCLUDE:
				getInclude().clear();
				getInclude().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_NOTIFICATION_SHAPE__REV_INCLUDE:
				getRevInclude().clear();
				getRevInclude().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
		}
