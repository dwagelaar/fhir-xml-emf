 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getParticipatingOrganization <em>Participating Organization</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getNetwork <em>Network</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getSpecialty <em>Specialty</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getHealthcareService <em>Healthcare Service</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OrganizationAffiliationImpl#getEndpoint <em>Endpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrganizationAffiliationImpl extends DomainResourceImpl implements OrganizationAffiliation {
	...
	public EList<ExtendedContactDetail> getContact() {
		if (contact == null) {
			contact = new EObjectContainmentEList<ExtendedContactDetail>(ExtendedContactDetail.class, this, FhirPackage.ORGANIZATION_AFFILIATION__CONTACT);
		}
		return contact;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.ORGANIZATION_AFFILIATION__CONTACT:
