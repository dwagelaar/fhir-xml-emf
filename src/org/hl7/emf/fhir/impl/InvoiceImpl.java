 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getCancelledReason <em>Cancelled Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getCreation <em>Creation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getPeriodDate <em>Period Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getPeriodPeriod <em>Period Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getParticipant <em>Participant</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getIssuer <em>Issuer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getLineItem <em>Line Item</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getTotalPriceComponent <em>Total Price Component</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getTotalNet <em>Total Net</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getTotalGross <em>Total Gross</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getPaymentTerms <em>Payment Terms</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InvoiceImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InvoiceImpl extends DomainResourceImpl implements Invoice {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String cancelledReason;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getCancelledReason() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCancelledReason(org.hl7.emf.fhir.String newCancelledReason, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldCancelledReason = cancelledReason;
	 ...
	 */
	@Override
	public void setCancelledReason(org.hl7.emf.fhir.String newCancelledReason) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.INVOICE__STATUS:
				...
				return;
			case FhirPackage.INVOICE__CANCELLED_REASON:
				setCancelledReason((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.INVOICE__TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.INVOICE__STATUS:
				...
				return;
			case FhirPackage.INVOICE__CANCELLED_REASON:
				setCancelledReason((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.INVOICE__TYPE:
