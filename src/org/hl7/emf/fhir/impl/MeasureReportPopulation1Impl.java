 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.MeasureReportPopulation1Impl#getLinkId <em>Link Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MeasureReportPopulation1Impl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MeasureReportPopulation1Impl#getCount <em>Count</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MeasureReportPopulation1Impl#getSubjectResults <em>Subject Results</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MeasureReportPopulation1Impl#getSubjectReport <em>Subject Report</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MeasureReportPopulation1Impl#getSubjects <em>Subjects</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasureReportPopulation1Impl extends BackboneElementImpl implements MeasureReportPopulation1 {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer count;
	...
	public NotificationChain basicSetLinkId(org.hl7.emf.fhir.String newLinkId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.MEASURE_REPORT_POPULATION1__LINK_ID, oldLinkId, newLinkId);
	...
	public void setLinkId(org.hl7.emf.fhir.String newLinkId) {
		if (newLinkId != linkId) {
			...
			if (linkId != null)
				msgs = ((InternalEObject)linkId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEASURE_REPORT_POPULATION1__LINK_ID, null, msgs);
			if (newLinkId != null)
				msgs = ((InternalEObject)newLinkId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEASURE_REPORT_POPULATION1__LINK_ID, null, msgs);
			msgs = basicSetLinkId(newLinkId, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.MEASURE_REPORT_POPULATION1__LINK_ID, newLinkId, newLinkId));
	}
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getCount() {
		return count;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCount(org.hl7.emf.fhir.Integer newCount, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldCount = count;
		count = newCount;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setCount(org.hl7.emf.fhir.Integer newCount) {
		if (newCount != count) {
			NotificationChain msgs = null;
			if (count != null)
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.MEASURE_REPORT_POPULATION1__LINK_ID:
			...
			case FhirPackage.MEASURE_REPORT_POPULATION1__SUBJECT_REPORT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.MEASURE_REPORT_POPULATION1__CODE:
				...
				return;
			case FhirPackage.MEASURE_REPORT_POPULATION1__COUNT:
				setCount((org.hl7.emf.fhir.Integer)newValue);
				return;
			case FhirPackage.MEASURE_REPORT_POPULATION1__SUBJECT_RESULTS:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.MEASURE_REPORT_POPULATION1__CODE:
				...
				return;
			case FhirPackage.MEASURE_REPORT_POPULATION1__COUNT:
				setCount((org.hl7.emf.fhir.Integer)null);
				return;
			case FhirPackage.MEASURE_REPORT_POPULATION1__SUBJECT_RESULTS:
