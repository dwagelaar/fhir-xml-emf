 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementSecurityImpl#getCors <em>Cors</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementSecurityImpl#getService <em>Service</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CapabilityStatementSecurityImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilityStatementSecurityImpl extends BackboneElementImpl implements CapabilityStatementSecurity {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean cors;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getCors() {
		return cors;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCors(org.hl7.emf.fhir.Boolean newCors, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldCors = cors;
		cors = newCors;
	 ...
	 */
	@Override
	public void setCors(org.hl7.emf.fhir.Boolean newCors) {
		if (newCors != cors) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.CAPABILITY_STATEMENT_SECURITY__CORS:
				setCors((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.CAPABILITY_STATEMENT_SECURITY__SERVICE:
				getService().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.CAPABILITY_STATEMENT_SECURITY__CORS:
				setCors((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.CAPABILITY_STATEMENT_SECURITY__SERVICE:
				getService().clear();
				return;
