 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getConnectionType <em>Connection Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getEnvironmentType <em>Environment Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getPayload <em>Payload</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EndpointImpl#getHeader <em>Header</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndpointImpl extends DomainResourceImpl implements Endpoint {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> header;
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getHeader() {
		if (header == null) {
			header = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.ENDPOINT__HEADER);
		}
		return header;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.ENDPOINT__HEADER:
				getHeader().clear();
				getHeader().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
		}
