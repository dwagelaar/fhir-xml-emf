 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ImplementationGuideTemplateImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ImplementationGuideTemplateImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ImplementationGuideTemplateImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationGuideTemplateImpl extends BackboneElementImpl implements ImplementationGuideTemplate {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String source;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String scope;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getSource() {
		return source;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSource(org.hl7.emf.fhir.String newSource, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldSource = source;
		source = newSource;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setSource(org.hl7.emf.fhir.String newSource) {
		if (newSource != source) {
			NotificationChain msgs = null;
			if (source != null)
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getScope() {
		return scope;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetScope(org.hl7.emf.fhir.String newScope, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldScope = scope;
		scope = newScope;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setScope(org.hl7.emf.fhir.String newScope) {
		if (newScope != scope) {
			NotificationChain msgs = null;
			if (scope != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.IMPLEMENTATION_GUIDE_TEMPLATE__CODE:
				...
				return;
			case FhirPackage.IMPLEMENTATION_GUIDE_TEMPLATE__SOURCE:
				setSource((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.IMPLEMENTATION_GUIDE_TEMPLATE__SCOPE:
				setScope((org.hl7.emf.fhir.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.IMPLEMENTATION_GUIDE_TEMPLATE__CODE:
				...
				return;
			case FhirPackage.IMPLEMENTATION_GUIDE_TEMPLATE__SOURCE:
				setSource((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.IMPLEMENTATION_GUIDE_TEMPLATE__SCOPE:
				setScope((org.hl7.emf.fhir.String)null);
				return;
		}
