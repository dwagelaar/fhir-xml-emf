 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getDeceasedBoolean <em>Deceased Boolean</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getDeceasedDateTime <em>Deceased Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getMaritalStatus <em>Marital Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getPhoto <em>Photo</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getCommunication <em>Communication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PersonImpl#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends DomainResourceImpl implements Person {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean active;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getActive() {
		return active;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetActive(org.hl7.emf.fhir.Boolean newActive, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldActive = active;
		active = newActive;
	 ...
	 */
	@Override
	public void setActive(org.hl7.emf.fhir.Boolean newActive) {
		if (newActive != active) {
	...
	public NotificationChain basicSetDeceasedBoolean(org.hl7.emf.fhir.Boolean newDeceasedBoolean, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PERSON__DECEASED_BOOLEAN, oldDeceasedBoolean, newDeceasedBoolean);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDeceasedBoolean(org.hl7.emf.fhir.Boolean newDeceasedBoolean) {
		if (newDeceasedBoolean != deceasedBoolean) {
			...
			if (deceasedBoolean != null)
				msgs = ((InternalEObject)deceasedBoolean).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PERSON__DECEASED_BOOLEAN, null, msgs);
			if (newDeceasedBoolean != null)
				msgs = ((InternalEObject)newDeceasedBoolean).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PERSON__DECEASED_BOOLEAN, null, msgs);
			msgs = basicSetDeceasedBoolean(newDeceasedBoolean, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PERSON__DECEASED_BOOLEAN, newDeceasedBoolean, newDeceasedBoolean));
	}
	...
	public NotificationChain basicSetDeceasedDateTime(DateTime newDeceasedDateTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PERSON__DECEASED_DATE_TIME, oldDeceasedDateTime, newDeceasedDateTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDeceasedDateTime(DateTime newDeceasedDateTime) {
		if (newDeceasedDateTime != deceasedDateTime) {
			...
			if (deceasedDateTime != null)
				msgs = ((InternalEObject)deceasedDateTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PERSON__DECEASED_DATE_TIME, null, msgs);
			if (newDeceasedDateTime != null)
				msgs = ((InternalEObject)newDeceasedDateTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PERSON__DECEASED_DATE_TIME, null, msgs);
			msgs = basicSetDeceasedDateTime(newDeceasedDateTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PERSON__DECEASED_DATE_TIME, newDeceasedDateTime, newDeceasedDateTime));
	}
	...
	public NotificationChain basicSetMaritalStatus(CodeableConcept newMaritalStatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PERSON__MARITAL_STATUS, oldMaritalStatus, newMaritalStatus);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaritalStatus(CodeableConcept newMaritalStatus) {
		if (newMaritalStatus != maritalStatus) {
			...
			if (maritalStatus != null)
				msgs = ((InternalEObject)maritalStatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PERSON__MARITAL_STATUS, null, msgs);
			if (newMaritalStatus != null)
				msgs = ((InternalEObject)newMaritalStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PERSON__MARITAL_STATUS, null, msgs);
			msgs = basicSetMaritalStatus(newMaritalStatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PERSON__MARITAL_STATUS, newMaritalStatus, newMaritalStatus));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.PERSON__COMMUNICATION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.PERSON__IDENTIFIER:
				...
				return;
			case FhirPackage.PERSON__ACTIVE:
				setActive((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.PERSON__NAME:
				getName().clear();
			...
			case FhirPackage.PERSON__COMMUNICATION:
				...
				getCommunication().addAll((Collection<? extends PersonCommunication>)newValue);
				return;
			case FhirPackage.PERSON__MANAGING_ORGANIZATION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.PERSON__IDENTIFIER:
				...
				return;
			case FhirPackage.PERSON__ACTIVE:
				setActive((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.PERSON__NAME:
				getName().clear();
				return;
