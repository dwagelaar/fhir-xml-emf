 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureMapStructureImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureMapStructureImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureMapStructureImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.StructureMapStructureImpl#getDocumentation <em>Documentation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureMapStructureImpl extends BackboneElementImpl implements StructureMapStructure {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String alias;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getAlias() {
		return alias;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAlias(org.hl7.emf.fhir.String newAlias, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldAlias = alias;
		alias = newAlias;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setAlias(org.hl7.emf.fhir.String newAlias) {
		if (newAlias != alias) {
			NotificationChain msgs = null;
			if (alias != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.STRUCTURE_MAP_STRUCTURE__MODE:
				...
				return;
			case FhirPackage.STRUCTURE_MAP_STRUCTURE__ALIAS:
				setAlias((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.STRUCTURE_MAP_STRUCTURE__DOCUMENTATION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.STRUCTURE_MAP_STRUCTURE__MODE:
				...
				return;
			case FhirPackage.STRUCTURE_MAP_STRUCTURE__ALIAS:
				setAlias((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.STRUCTURE_MAP_STRUCTURE__DOCUMENTATION:
