 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.AccountGuarantorImpl#getParty <em>Party</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AccountGuarantorImpl#getOnHold <em>On Hold</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AccountGuarantorImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccountGuarantorImpl extends BackboneElementImpl implements AccountGuarantor {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean onHold;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getOnHold() {
		return onHold;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOnHold(org.hl7.emf.fhir.Boolean newOnHold, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldOnHold = onHold;
		onHold = newOnHold;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setOnHold(org.hl7.emf.fhir.Boolean newOnHold) {
		if (newOnHold != onHold) {
			NotificationChain msgs = null;
			if (onHold != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.ACCOUNT_GUARANTOR__PARTY:
				...
				return;
			case FhirPackage.ACCOUNT_GUARANTOR__ON_HOLD:
				setOnHold((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.ACCOUNT_GUARANTOR__PERIOD:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.ACCOUNT_GUARANTOR__PARTY:
				...
				return;
			case FhirPackage.ACCOUNT_GUARANTOR__ON_HOLD:
				setOnHold((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.ACCOUNT_GUARANTOR__PERIOD:
