 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getServicedDate <em>Serviced Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getServicedPeriod <em>Serviced Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getEnterer <em>Enterer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getInsurer <em>Insurer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getFacility <em>Facility</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getSupportingInfo <em>Supporting Info</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getInsurance <em>Insurance</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageEligibilityRequestImpl#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CoverageEligibilityRequestImpl extends DomainResourceImpl implements CoverageEligibilityRequest {
	...
	public EList<CoverageEligibilityRequestEvent> getEvent() {
		if (event == null) {
			event = new EObjectContainmentEList<CoverageEligibilityRequestEvent>(CoverageEligibilityRequestEvent.class, this, FhirPackage.COVERAGE_ELIGIBILITY_REQUEST__EVENT);
		}
		return event;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.COVERAGE_ELIGIBILITY_REQUEST__EVENT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.COVERAGE_ELIGIBILITY_REQUEST__EVENT:
				getEvent().clear();
				getEvent().addAll((Collection<? extends CoverageEligibilityRequestEvent>)newValue);
				return;
			case FhirPackage.COVERAGE_ELIGIBILITY_REQUEST__SERVICED_DATE:
