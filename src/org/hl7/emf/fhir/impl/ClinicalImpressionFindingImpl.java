 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionFindingImpl#getItem <em>Item</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionFindingImpl#getBasis <em>Basis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClinicalImpressionFindingImpl extends BackboneElementImpl implements ClinicalImpressionFinding {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String basis;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getBasis() {
		return basis;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBasis(org.hl7.emf.fhir.String newBasis, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldBasis = basis;
		basis = newBasis;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setBasis(org.hl7.emf.fhir.String newBasis) {
		if (newBasis != basis) {
			NotificationChain msgs = null;
			if (basis != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.CLINICAL_IMPRESSION_FINDING__ITEM:
				...
				return;
			case FhirPackage.CLINICAL_IMPRESSION_FINDING__BASIS:
				setBasis((org.hl7.emf.fhir.String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.CLINICAL_IMPRESSION_FINDING__ITEM:
				...
				return;
			case FhirPackage.CLINICAL_IMPRESSION_FINDING__BASIS:
				setBasis((org.hl7.emf.fhir.String)null);
				return;
		}
