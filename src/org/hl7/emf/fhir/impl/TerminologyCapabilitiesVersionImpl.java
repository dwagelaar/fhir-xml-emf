 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesVersionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesVersionImpl#getIsDefault <em>Is Default</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesVersionImpl#getCompositional <em>Compositional</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesVersionImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesVersionImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesVersionImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TerminologyCapabilitiesVersionImpl extends BackboneElementImpl implements TerminologyCapabilitiesVersion {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String code;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean isDefault;
	 ...
	 * @ordered
	 */
	protected EList<CommonLanguages> language;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getCode() {
		return code;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCode(org.hl7.emf.fhir.String newCode, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldCode = code;
		code = newCode;
	 ...
	 */
	@Override
	public void setCode(org.hl7.emf.fhir.String newCode) {
		if (newCode != code) {
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getIsDefault() {
		return isDefault;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIsDefault(org.hl7.emf.fhir.Boolean newIsDefault, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldIsDefault = isDefault;
	 ...
	 */
	@Override
	public void setIsDefault(org.hl7.emf.fhir.Boolean newIsDefault) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.TERMINOLOGY_CAPABILITIES_VERSION__CODE:
				setCode((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_VERSION__IS_DEFAULT:
				setIsDefault((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_VERSION__COMPOSITIONAL:
			...
			case FhirPackage.TERMINOLOGY_CAPABILITIES_VERSION__LANGUAGE:
				getLanguage().clear();
				getLanguage().addAll((Collection<? extends CommonLanguages>)newValue);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_VERSION__FILTER:
				getFilter().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.TERMINOLOGY_CAPABILITIES_VERSION__CODE:
				setCode((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_VERSION__IS_DEFAULT:
				setIsDefault((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_VERSION__COMPOSITIONAL:
