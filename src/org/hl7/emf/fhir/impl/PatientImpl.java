 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getDeceasedBoolean <em>Deceased Boolean</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getDeceasedDateTime <em>Deceased Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getMaritalStatus <em>Marital Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getMultipleBirthBoolean <em>Multiple Birth Boolean</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getMultipleBirthInteger <em>Multiple Birth Integer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getPhoto <em>Photo</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getCommunication <em>Communication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getGeneralPractitioner <em>General Practitioner</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getManagingOrganization <em>Managing Organization</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PatientImpl#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatientImpl extends DomainResourceImpl implements Patient {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean multipleBirthBoolean;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer multipleBirthInteger;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getMultipleBirthBoolean() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMultipleBirthBoolean(org.hl7.emf.fhir.Boolean newMultipleBirthBoolean, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldMultipleBirthBoolean = multipleBirthBoolean;
	 ...
	 */
	@Override
	public void setMultipleBirthBoolean(org.hl7.emf.fhir.Boolean newMultipleBirthBoolean) {
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getMultipleBirthInteger() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMultipleBirthInteger(org.hl7.emf.fhir.Integer newMultipleBirthInteger, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldMultipleBirthInteger = multipleBirthInteger;
	 ...
	 */
	@Override
	public void setMultipleBirthInteger(org.hl7.emf.fhir.Integer newMultipleBirthInteger) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.PATIENT__MARITAL_STATUS:
				...
				return;
			case FhirPackage.PATIENT__MULTIPLE_BIRTH_BOOLEAN:
				setMultipleBirthBoolean((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.PATIENT__MULTIPLE_BIRTH_INTEGER:
				setMultipleBirthInteger((org.hl7.emf.fhir.Integer)newValue);
				return;
			case FhirPackage.PATIENT__PHOTO:
				getPhoto().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.PATIENT__MARITAL_STATUS:
				...
				return;
			case FhirPackage.PATIENT__MULTIPLE_BIRTH_BOOLEAN:
				setMultipleBirthBoolean((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.PATIENT__MULTIPLE_BIRTH_INTEGER:
				setMultipleBirthInteger((org.hl7.emf.fhir.Integer)null);
				return;
			case FhirPackage.PATIENT__PHOTO:
				getPhoto().clear();
				return;
