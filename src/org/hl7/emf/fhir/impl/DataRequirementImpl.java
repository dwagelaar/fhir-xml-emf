 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getProfile <em>Profile</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getSubjectCodeableConcept <em>Subject Codeable Concept</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getSubjectReference <em>Subject Reference</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getMustSupport <em>Must Support</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getCodeFilter <em>Code Filter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getDateFilter <em>Date Filter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getValueFilter <em>Value Filter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getLimit <em>Limit</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DataRequirementImpl#getSort <em>Sort</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataRequirementImpl extends DataTypeImpl implements DataRequirement {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> mustSupport;
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getMustSupport() {
		if (mustSupport == null) {
			mustSupport = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.DATA_REQUIREMENT__MUST_SUPPORT);
		}
		return mustSupport;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.DATA_REQUIREMENT__MUST_SUPPORT:
				...
				getMustSupport().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.DATA_REQUIREMENT__CODE_FILTER:
				getCodeFilter().clear();
