 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicinalProductDefinitionPartImpl#getPart <em>Part</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicinalProductDefinitionPartImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicinalProductDefinitionPartImpl extends BackboneElementImpl implements MedicinalProductDefinitionPart {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String part;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getPart() {
		return part;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPart(org.hl7.emf.fhir.String newPart, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldPart = part;
		part = newPart;
	 ...
	 */
	@Override
	public void setPart(org.hl7.emf.fhir.String newPart) {
		if (newPart != part) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.MEDICINAL_PRODUCT_DEFINITION_PART__PART:
				setPart((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.MEDICINAL_PRODUCT_DEFINITION_PART__TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.MEDICINAL_PRODUCT_DEFINITION_PART__PART:
				setPart((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.MEDICINAL_PRODUCT_DEFINITION_PART__TYPE:
