 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getSequenceType <em>Sequence Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getNumberOfSubunits <em>Number Of Subunits</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getAreaOfHybridisation <em>Area Of Hybridisation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getOligoNucleotideType <em>Oligo Nucleotide Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getSubunit <em>Subunit</em>}</li>
 * </ul>
 *
 * @see org.hl7.emf.fhir.FhirPackage#getSubstanceNucleicAcid()
...
public interface SubstanceNucleicAcid extends DomainResource {
	 ...
	 * @see org.hl7.emf.fhir.FhirPackage#getSubstanceNucleicAcid_SequenceType()
	...
	/**
	 * Sets the value of the '{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getSequenceType <em>Sequence Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setNumberOfSubunits(org.hl7.emf.fhir.Integer)
	 * @see org.hl7.emf.fhir.FhirPackage#getSubstanceNucleicAcid_NumberOfSubunits()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='numberOfSubunits' namespace='##targetNamespace'"
	 * @generated
	 */
	org.hl7.emf.fhir.Integer getNumberOfSubunits();

	/**
	 * Sets the value of the '{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getNumberOfSubunits <em>Number Of Subunits</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setNumberOfSubunits(org.hl7.emf.fhir.Integer value);
	 ...
	 * @see #setAreaOfHybridisation(org.hl7.emf.fhir.String)
	 * @see org.hl7.emf.fhir.FhirPackage#getSubstanceNucleicAcid_AreaOfHybridisation()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='areaOfHybridisation' namespace='##targetNamespace'"
	 * @generated
	 */
	org.hl7.emf.fhir.String getAreaOfHybridisation();

	/**
	 * Sets the value of the '{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getAreaOfHybridisation <em>Area Of Hybridisation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setAreaOfHybridisation(org.hl7.emf.fhir.String value);
	 ...
	 * @see org.hl7.emf.fhir.FhirPackage#getSubstanceNucleicAcid_OligoNucleotideType()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.hl7.emf.fhir.SubstanceNucleicAcid#getOligoNucleotideType <em>Oligo Nucleotide Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.hl7.emf.fhir.SubstanceNucleicAcidSubunit}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see org.hl7.emf.fhir.FhirPackage#getSubstanceNucleicAcid_Subunit()
	 * @model containment="true"
