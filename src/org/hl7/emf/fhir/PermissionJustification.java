 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.PermissionJustification#getBasis <em>Basis</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.PermissionJustification#getEvidence <em>Evidence</em>}</li>
 * </ul>
 *
 * @see org.hl7.emf.fhir.FhirPackage#getPermissionJustification()
...
public interface PermissionJustification extends BackboneElement {
	 ...
	 * @see org.hl7.emf.fhir.FhirPackage#getPermissionJustification_Basis()
	 ...
	 * @see org.hl7.emf.fhir.FhirPackage#getPermissionJustification_Evidence()
	 * @model containment="true"
