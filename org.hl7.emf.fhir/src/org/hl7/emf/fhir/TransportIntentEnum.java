...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Transport Intent Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.emf.fhir.FhirPackage#getTransportIntentEnum()
 * @model extendedMetaData="name='TransportIntentEnum'"
 * @generated
 */
public enum TransportIntentEnum implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>Transport Intent Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TransportIntentEnum[] VALUES_ARRAY =
		new TransportIntentEnum[] {
			UNKNOWN,
			PROPOSAL,
			PLAN,
			ORDER,
	...
	/**
	 * A public read-only list of all the '<em><b>Transport Intent Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TransportIntentEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Transport Intent Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TransportIntentEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TransportIntentEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Transport Intent Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static TransportIntentEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TransportIntentEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Transport Intent Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TransportIntentEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TransportIntentEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
