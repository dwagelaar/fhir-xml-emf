 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.ExplanationOfBenefitBodySite#getSite <em>Site</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.ExplanationOfBenefitBodySite#getSubSite <em>Sub Site</em>}</li>
 * </ul>
 *
 * @see org.hl7.emf.fhir.FhirPackage#getExplanationOfBenefitBodySite()
...
public interface ExplanationOfBenefitBodySite extends BackboneElement {
	 ...
	 * @see org.hl7.emf.fhir.FhirPackage#getExplanationOfBenefitBodySite_Site()
	 ...
	 * @see org.hl7.emf.fhir.FhirPackage#getExplanationOfBenefitBodySite_SubSite()
