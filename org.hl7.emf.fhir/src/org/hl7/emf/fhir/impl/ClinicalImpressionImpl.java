 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getStatusReason <em>Status Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getEffectiveDateTime <em>Effective Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getEffectivePeriod <em>Effective Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getPrevious <em>Previous</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getProblem <em>Problem</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getChangePattern <em>Change Pattern</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getProtocol <em>Protocol</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getFinding <em>Finding</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getPrognosisCodeableConcept <em>Prognosis Codeable Concept</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getPrognosisReference <em>Prognosis Reference</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getSupportingInfo <em>Supporting Info</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClinicalImpressionImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClinicalImpressionImpl extends DomainResourceImpl implements ClinicalImpression {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String summary;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getSummary() {
		return summary;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSummary(org.hl7.emf.fhir.String newSummary, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldSummary = summary;
		summary = newSummary;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setSummary(org.hl7.emf.fhir.String newSummary) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.CLINICAL_IMPRESSION__PROTOCOL:
				...
				return;
			case FhirPackage.CLINICAL_IMPRESSION__SUMMARY:
				setSummary((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.CLINICAL_IMPRESSION__FINDING:
				getFinding().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.CLINICAL_IMPRESSION__PROTOCOL:
				...
				return;
			case FhirPackage.CLINICAL_IMPRESSION__SUMMARY:
				setSummary((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.CLINICAL_IMPRESSION__FINDING:
				getFinding().clear();
				return;
