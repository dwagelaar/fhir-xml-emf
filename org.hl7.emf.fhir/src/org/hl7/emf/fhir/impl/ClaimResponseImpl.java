 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getTraceNumber <em>Trace Number</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getSubType <em>Sub Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getUse <em>Use</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getInsurer <em>Insurer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getRequestor <em>Requestor</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getDecision <em>Decision</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getPreAuthRef <em>Pre Auth Ref</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getPreAuthPeriod <em>Pre Auth Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getPayeeType <em>Payee Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getDiagnosisRelatedGroup <em>Diagnosis Related Group</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getItem <em>Item</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getAddItem <em>Add Item</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getAdjudication <em>Adjudication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getTotal <em>Total</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getPayment <em>Payment</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getFundsReserve <em>Funds Reserve</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getFormCode <em>Form Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getForm <em>Form</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getProcessNote <em>Process Note</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getCommunicationRequest <em>Communication Request</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getInsurance <em>Insurance</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimResponseImpl#getError <em>Error</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimResponseImpl extends DomainResourceImpl implements ClaimResponse {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String preAuthRef;
	...
	public EList<Identifier> getTraceNumber() {
		if (traceNumber == null) {
			traceNumber = new EObjectContainmentEList<Identifier>(Identifier.class, this, FhirPackage.CLAIM_RESPONSE__TRACE_NUMBER);
		}
		return traceNumber;
	}
	...
	public NotificationChain basicSetDecision(CodeableConcept newDecision, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_RESPONSE__DECISION, oldDecision, newDecision);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDecision(CodeableConcept newDecision) {
		if (newDecision != decision) {
			NotificationChain msgs = null;
			if (decision != null)
				msgs = ((InternalEObject)decision).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_RESPONSE__DECISION, null, msgs);
			if (newDecision != null)
				msgs = ((InternalEObject)newDecision).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_RESPONSE__DECISION, null, msgs);
			msgs = basicSetDecision(newDecision, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_RESPONSE__DECISION, newDecision, newDecision));
	}
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getPreAuthRef() {
		return preAuthRef;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPreAuthRef(org.hl7.emf.fhir.String newPreAuthRef, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldPreAuthRef = preAuthRef;
	 ...
	 */
	@Override
	public void setPreAuthRef(org.hl7.emf.fhir.String newPreAuthRef) {
	...
	public EList<ClaimResponseEvent> getEvent() {
		if (event == null) {
			event = new EObjectContainmentEList<ClaimResponseEvent>(ClaimResponseEvent.class, this, FhirPackage.CLAIM_RESPONSE__EVENT);
		}
		return event;
	}
	...
	public EList<Reference> getEncounter() {
		if (encounter == null) {
			encounter = new EObjectContainmentEList<Reference>(Reference.class, this, FhirPackage.CLAIM_RESPONSE__ENCOUNTER);
		}
		return encounter;
	}
	...
	public NotificationChain basicSetDiagnosisRelatedGroup(CodeableConcept newDiagnosisRelatedGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_RESPONSE__DIAGNOSIS_RELATED_GROUP, oldDiagnosisRelatedGroup, newDiagnosisRelatedGroup);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDiagnosisRelatedGroup(CodeableConcept newDiagnosisRelatedGroup) {
		if (newDiagnosisRelatedGroup != diagnosisRelatedGroup) {
			...
			if (diagnosisRelatedGroup != null)
				msgs = ((InternalEObject)diagnosisRelatedGroup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_RESPONSE__DIAGNOSIS_RELATED_GROUP, null, msgs);
			if (newDiagnosisRelatedGroup != null)
				msgs = ((InternalEObject)newDiagnosisRelatedGroup).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_RESPONSE__DIAGNOSIS_RELATED_GROUP, null, msgs);
			msgs = basicSetDiagnosisRelatedGroup(newDiagnosisRelatedGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_RESPONSE__DIAGNOSIS_RELATED_GROUP, newDiagnosisRelatedGroup, newDiagnosisRelatedGroup));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.CLAIM_RESPONSE__TRACE_NUMBER:
			...
			case FhirPackage.CLAIM_RESPONSE__DECISION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.CLAIM_RESPONSE__DISPOSITION:
				...
				return;
			case FhirPackage.CLAIM_RESPONSE__PRE_AUTH_REF:
				setPreAuthRef((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.CLAIM_RESPONSE__PRE_AUTH_PERIOD:
			...
			case FhirPackage.CLAIM_RESPONSE__EVENT:
				getEvent().clear();
				getEvent().addAll((Collection<? extends ClaimResponseEvent>)newValue);
				return;
			case FhirPackage.CLAIM_RESPONSE__PAYEE_TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.CLAIM_RESPONSE__DISPOSITION:
				...
				return;
			case FhirPackage.CLAIM_RESPONSE__PRE_AUTH_REF:
				setPreAuthRef((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.CLAIM_RESPONSE__PRE_AUTH_PERIOD:
