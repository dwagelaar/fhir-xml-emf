 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getTraceNumber <em>Trace Number</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getSubType <em>Sub Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getUse <em>Use</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getBillablePeriod <em>Billable Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getEnterer <em>Enterer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getInsurer <em>Insurer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getFundsReserveRequested <em>Funds Reserve Requested</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getFundsReserve <em>Funds Reserve</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getRelated <em>Related</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPrescription <em>Prescription</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getOriginalPrescription <em>Original Prescription</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPayee <em>Payee</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getReferral <em>Referral</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getFacility <em>Facility</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getClaim <em>Claim</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getClaimResponse <em>Claim Response</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getDecision <em>Decision</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPreAuthRef <em>Pre Auth Ref</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPreAuthRefPeriod <em>Pre Auth Ref Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getDiagnosisRelatedGroup <em>Diagnosis Related Group</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getCareTeam <em>Care Team</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getSupportingInfo <em>Supporting Info</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getDiagnosis <em>Diagnosis</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getProcedure <em>Procedure</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPrecedence <em>Precedence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getInsurance <em>Insurance</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getAccident <em>Accident</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPatientPaid <em>Patient Paid</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getItem <em>Item</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getAddItem <em>Add Item</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getAdjudication <em>Adjudication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getTotal <em>Total</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getPayment <em>Payment</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getFormCode <em>Form Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getForm <em>Form</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getProcessNote <em>Process Note</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getBenefitPeriod <em>Benefit Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitImpl#getBenefitBalance <em>Benefit Balance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplanationOfBenefitImpl extends DomainResourceImpl implements ExplanationOfBenefit {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String disposition;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> preAuthRef;
	...
	public EList<Identifier> getTraceNumber() {
		if (traceNumber == null) {
			traceNumber = new EObjectContainmentEList<Identifier>(Identifier.class, this, FhirPackage.EXPLANATION_OF_BENEFIT__TRACE_NUMBER);
		}
		return traceNumber;
	}
	...
	public EList<ExplanationOfBenefitEvent> getEvent() {
		if (event == null) {
			event = new EObjectContainmentEList<ExplanationOfBenefitEvent>(ExplanationOfBenefitEvent.class, this, FhirPackage.EXPLANATION_OF_BENEFIT__EVENT);
		}
		return event;
	}
	...
	public EList<Reference> getEncounter() {
		if (encounter == null) {
			encounter = new EObjectContainmentEList<Reference>(Reference.class, this, FhirPackage.EXPLANATION_OF_BENEFIT__ENCOUNTER);
		}
		return encounter;
	}
	...
	public NotificationChain basicSetDecision(CodeableConcept newDecision, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT__DECISION, oldDecision, newDecision);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDecision(CodeableConcept newDecision) {
		if (newDecision != decision) {
			NotificationChain msgs = null;
			if (decision != null)
				msgs = ((InternalEObject)decision).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT__DECISION, null, msgs);
			if (newDecision != null)
				msgs = ((InternalEObject)newDecision).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT__DECISION, null, msgs);
			msgs = basicSetDecision(newDecision, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT__DECISION, newDecision, newDecision));
	}
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getDisposition() {
		return disposition;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDisposition(org.hl7.emf.fhir.String newDisposition, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldDisposition = disposition;
	 ...
	 */
	@Override
	public void setDisposition(org.hl7.emf.fhir.String newDisposition) {
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getPreAuthRef() {
		if (preAuthRef == null) {
			preAuthRef = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.EXPLANATION_OF_BENEFIT__PRE_AUTH_REF);
		}
		return preAuthRef;
	}
	...
	public NotificationChain basicSetDiagnosisRelatedGroup(CodeableConcept newDiagnosisRelatedGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT__DIAGNOSIS_RELATED_GROUP, oldDiagnosisRelatedGroup, newDiagnosisRelatedGroup);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDiagnosisRelatedGroup(CodeableConcept newDiagnosisRelatedGroup) {
		if (newDiagnosisRelatedGroup != diagnosisRelatedGroup) {
			...
			if (diagnosisRelatedGroup != null)
				msgs = ((InternalEObject)diagnosisRelatedGroup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT__DIAGNOSIS_RELATED_GROUP, null, msgs);
			if (newDiagnosisRelatedGroup != null)
				msgs = ((InternalEObject)newDiagnosisRelatedGroup).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT__DIAGNOSIS_RELATED_GROUP, null, msgs);
			msgs = basicSetDiagnosisRelatedGroup(newDiagnosisRelatedGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT__DIAGNOSIS_RELATED_GROUP, newDiagnosisRelatedGroup, newDiagnosisRelatedGroup));
	}
	...
	public NotificationChain basicSetPatientPaid(Money newPatientPaid, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT__PATIENT_PAID, oldPatientPaid, newPatientPaid);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPatientPaid(Money newPatientPaid) {
		if (newPatientPaid != patientPaid) {
			NotificationChain msgs = null;
			if (patientPaid != null)
				msgs = ((InternalEObject)patientPaid).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT__PATIENT_PAID, null, msgs);
			if (newPatientPaid != null)
				msgs = ((InternalEObject)newPatientPaid).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT__PATIENT_PAID, null, msgs);
			msgs = basicSetPatientPaid(newPatientPaid, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT__PATIENT_PAID, newPatientPaid, newPatientPaid));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__TRACE_NUMBER:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__EVENT:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__ENCOUNTER:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__DECISION:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__DIAGNOSIS_RELATED_GROUP:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__PATIENT_PAID:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__EVENT:
				getEvent().clear();
				getEvent().addAll((Collection<? extends ExplanationOfBenefitEvent>)newValue);
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT__PAYEE:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__DECISION:
				...
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT__DISPOSITION:
				setDisposition((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT__PRE_AUTH_REF:
				getPreAuthRef().clear();
				getPreAuthRef().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT__PRE_AUTH_REF_PERIOD:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT__DECISION:
				...
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT__DISPOSITION:
				setDisposition((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT__PRE_AUTH_REF:
				getPreAuthRef().clear();
				return;
