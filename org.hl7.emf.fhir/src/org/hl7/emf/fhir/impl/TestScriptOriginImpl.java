 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.TestScriptOriginImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TestScriptOriginImpl#getProfile <em>Profile</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TestScriptOriginImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestScriptOriginImpl extends BackboneElementImpl implements TestScriptOrigin {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer index;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getIndex() {
		return index;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIndex(org.hl7.emf.fhir.Integer newIndex, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldIndex = index;
		index = newIndex;
	 ...
	 */
	@Override
	public void setIndex(org.hl7.emf.fhir.Integer newIndex) {
		if (newIndex != index) {
	...
	public NotificationChain basicSetUrl(Url newUrl, NotificationChain msgs) {
		...
		url = newUrl;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TEST_SCRIPT_ORIGIN__URL, oldUrl, newUrl);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUrl(Url newUrl) {
		if (newUrl != url) {
			NotificationChain msgs = null;
			if (url != null)
				msgs = ((InternalEObject)url).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TEST_SCRIPT_ORIGIN__URL, null, msgs);
			if (newUrl != null)
				msgs = ((InternalEObject)newUrl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TEST_SCRIPT_ORIGIN__URL, null, msgs);
			msgs = basicSetUrl(newUrl, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TEST_SCRIPT_ORIGIN__URL, newUrl, newUrl));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.TEST_SCRIPT_ORIGIN__URL:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.TEST_SCRIPT_ORIGIN__INDEX:
				setIndex((org.hl7.emf.fhir.Integer)newValue);
				return;
			case FhirPackage.TEST_SCRIPT_ORIGIN__PROFILE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.TEST_SCRIPT_ORIGIN__INDEX:
				setIndex((org.hl7.emf.fhir.Integer)null);
				return;
			case FhirPackage.TEST_SCRIPT_ORIGIN__PROFILE:
