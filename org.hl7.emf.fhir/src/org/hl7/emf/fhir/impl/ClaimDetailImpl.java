 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getTraceNumber <em>Trace Number</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getRevenue <em>Revenue</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getProductOrService <em>Product Or Service</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getProductOrServiceEnd <em>Product Or Service End</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getModifier <em>Modifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getProgramCode <em>Program Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getPatientPaid <em>Patient Paid</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getTax <em>Tax</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getNet <em>Net</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getUdi <em>Udi</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimDetailImpl#getSubDetail <em>Sub Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimDetailImpl extends BackboneElementImpl implements ClaimDetail {
	...
	public EList<Identifier> getTraceNumber() {
		if (traceNumber == null) {
			traceNumber = new EObjectContainmentEList<Identifier>(Identifier.class, this, FhirPackage.CLAIM_DETAIL__TRACE_NUMBER);
		}
		return traceNumber;
	}
	...
	public NotificationChain basicSetProductOrServiceEnd(CodeableConcept newProductOrServiceEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_DETAIL__PRODUCT_OR_SERVICE_END, oldProductOrServiceEnd, newProductOrServiceEnd);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProductOrServiceEnd(CodeableConcept newProductOrServiceEnd) {
		if (newProductOrServiceEnd != productOrServiceEnd) {
			...
			if (productOrServiceEnd != null)
				msgs = ((InternalEObject)productOrServiceEnd).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_DETAIL__PRODUCT_OR_SERVICE_END, null, msgs);
			if (newProductOrServiceEnd != null)
				msgs = ((InternalEObject)newProductOrServiceEnd).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_DETAIL__PRODUCT_OR_SERVICE_END, null, msgs);
			msgs = basicSetProductOrServiceEnd(newProductOrServiceEnd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_DETAIL__PRODUCT_OR_SERVICE_END, newProductOrServiceEnd, newProductOrServiceEnd));
	}
	...
	public NotificationChain basicSetPatientPaid(Money newPatientPaid, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_DETAIL__PATIENT_PAID, oldPatientPaid, newPatientPaid);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPatientPaid(Money newPatientPaid) {
		if (newPatientPaid != patientPaid) {
			NotificationChain msgs = null;
			if (patientPaid != null)
				msgs = ((InternalEObject)patientPaid).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_DETAIL__PATIENT_PAID, null, msgs);
			if (newPatientPaid != null)
				msgs = ((InternalEObject)newPatientPaid).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_DETAIL__PATIENT_PAID, null, msgs);
			msgs = basicSetPatientPaid(newPatientPaid, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_DETAIL__PATIENT_PAID, newPatientPaid, newPatientPaid));
	}
	...
	public NotificationChain basicSetTax(Money newTax, NotificationChain msgs) {
		...
		tax = newTax;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_DETAIL__TAX, oldTax, newTax);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTax(Money newTax) {
		if (newTax != tax) {
			NotificationChain msgs = null;
			if (tax != null)
				msgs = ((InternalEObject)tax).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_DETAIL__TAX, null, msgs);
			if (newTax != null)
				msgs = ((InternalEObject)newTax).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CLAIM_DETAIL__TAX, null, msgs);
			msgs = basicSetTax(newTax, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CLAIM_DETAIL__TAX, newTax, newTax));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.CLAIM_DETAIL__TRACE_NUMBER:
			...
			case FhirPackage.CLAIM_DETAIL__PRODUCT_OR_SERVICE_END:
			...
			case FhirPackage.CLAIM_DETAIL__PATIENT_PAID:
			...
			case FhirPackage.CLAIM_DETAIL__TAX:
