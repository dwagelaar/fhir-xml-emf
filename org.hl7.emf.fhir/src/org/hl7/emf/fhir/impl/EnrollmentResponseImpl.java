 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.EnrollmentResponseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EnrollmentResponseImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EnrollmentResponseImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EnrollmentResponseImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EnrollmentResponseImpl#getDisposition <em>Disposition</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EnrollmentResponseImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EnrollmentResponseImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EnrollmentResponseImpl#getRequestProvider <em>Request Provider</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnrollmentResponseImpl extends DomainResourceImpl implements EnrollmentResponse {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOutcome(EnrollmentOutcome newOutcome, NotificationChain msgs) {
		EnrollmentOutcome oldOutcome = outcome;
		outcome = newOutcome;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setOutcome(EnrollmentOutcome newOutcome) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.ENROLLMENT_RESPONSE__REQUEST:
				...
				return;
			case FhirPackage.ENROLLMENT_RESPONSE__OUTCOME:
				setOutcome((EnrollmentOutcome)newValue);
				return;
			case FhirPackage.ENROLLMENT_RESPONSE__DISPOSITION:
