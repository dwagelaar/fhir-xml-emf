 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceProteinImpl#getSequenceType <em>Sequence Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceProteinImpl#getNumberOfSubunits <em>Number Of Subunits</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceProteinImpl#getDisulfideLinkage <em>Disulfide Linkage</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstanceProteinImpl#getSubunit <em>Subunit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstanceProteinImpl extends DomainResourceImpl implements SubstanceProtein {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> disulfideLinkage;
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getDisulfideLinkage() {
		if (disulfideLinkage == null) {
			disulfideLinkage = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.SUBSTANCE_PROTEIN__DISULFIDE_LINKAGE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SUBSTANCE_PROTEIN__DISULFIDE_LINKAGE:
				...
				getDisulfideLinkage().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.SUBSTANCE_PROTEIN__SUBUNIT:
				getSubunit().clear();
