 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getPaymentBy <em>Payment By</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getPolicyHolder <em>Policy Holder</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getSubscriber <em>Subscriber</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getSubscriberId <em>Subscriber Id</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getBeneficiary <em>Beneficiary</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getDependent <em>Dependent</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getInsurer <em>Insurer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getNetwork <em>Network</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getCostToBeneficiary <em>Cost To Beneficiary</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getSubrogation <em>Subrogation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getContract <em>Contract</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CoverageImpl#getInsurancePlan <em>Insurance Plan</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CoverageImpl extends DomainResourceImpl implements Coverage {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String dependent;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String network;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean subrogation;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getDependent() {
		return dependent;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDependent(org.hl7.emf.fhir.String newDependent, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldDependent = dependent;
	 ...
	 */
	@Override
	public void setDependent(org.hl7.emf.fhir.String newDependent) {
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getNetwork() {
		return network;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNetwork(org.hl7.emf.fhir.String newNetwork, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldNetwork = network;
		network = newNetwork;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setNetwork(org.hl7.emf.fhir.String newNetwork) {
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getSubrogation() {
		return subrogation;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSubrogation(org.hl7.emf.fhir.Boolean newSubrogation, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldSubrogation = subrogation;
	 ...
	 */
	@Override
	public void setSubrogation(org.hl7.emf.fhir.Boolean newSubrogation) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.COVERAGE__BENEFICIARY:
				...
				return;
			case FhirPackage.COVERAGE__DEPENDENT:
				setDependent((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.COVERAGE__RELATIONSHIP:
			...
			case FhirPackage.COVERAGE__ORDER:
				...
				return;
			case FhirPackage.COVERAGE__NETWORK:
				setNetwork((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.COVERAGE__COST_TO_BENEFICIARY:
				...
				return;
			case FhirPackage.COVERAGE__SUBROGATION:
				setSubrogation((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.COVERAGE__CONTRACT:
				getContract().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.COVERAGE__BENEFICIARY:
				...
				return;
			case FhirPackage.COVERAGE__DEPENDENT:
				setDependent((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.COVERAGE__RELATIONSHIP:
			...
			case FhirPackage.COVERAGE__ORDER:
				...
				return;
			case FhirPackage.COVERAGE__NETWORK:
				setNetwork((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.COVERAGE__COST_TO_BENEFICIARY:
				getCostToBeneficiary().clear();
				return;
			case FhirPackage.COVERAGE__SUBROGATION:
				setSubrogation((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.COVERAGE__CONTRACT:
				getContract().clear();
				return;
