...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Imaging Selection Image Region3 D</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ImagingSelectionImageRegion3DImpl#getRegionType <em>Region Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ImagingSelectionImageRegion3DImpl#getCoordinate <em>Coordinate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImagingSelectionImageRegion3DImpl extends BackboneElementImpl implements ImagingSelectionImageRegion3D {
	/**
	 ...
	 * @generated
	 */
	protected ImagingSelectionImageRegion3DImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getImagingSelectionImageRegion3D();
	}
	...
	public NotificationChain basicSetRegionType(ImagingSelectionDGraphicType newRegionType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.IMAGING_SELECTION_IMAGE_REGION3_D__REGION_TYPE, oldRegionType, newRegionType);
	...
	public void setRegionType(ImagingSelectionDGraphicType newRegionType) {
		if (newRegionType != regionType) {
			...
			if (regionType != null)
				msgs = ((InternalEObject)regionType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.IMAGING_SELECTION_IMAGE_REGION3_D__REGION_TYPE, null, msgs);
			if (newRegionType != null)
				msgs = ((InternalEObject)newRegionType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.IMAGING_SELECTION_IMAGE_REGION3_D__REGION_TYPE, null, msgs);
			msgs = basicSetRegionType(newRegionType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.IMAGING_SELECTION_IMAGE_REGION3_D__REGION_TYPE, newRegionType, newRegionType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.IMAGING_SELECTION_IMAGE_REGION3_D__REGION_TYPE:
				return basicSetRegionType(null, msgs);
			case FhirPackage.IMAGING_SELECTION_IMAGE_REGION3_D__COORDINATE:
...
} //ImagingSelectionImageRegion3DImpl
