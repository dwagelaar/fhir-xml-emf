 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SubscriptionTopicQueryCriteriaImpl#getPrevious <em>Previous</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubscriptionTopicQueryCriteriaImpl#getResultForCreate <em>Result For Create</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubscriptionTopicQueryCriteriaImpl#getCurrent <em>Current</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubscriptionTopicQueryCriteriaImpl#getResultForDelete <em>Result For Delete</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubscriptionTopicQueryCriteriaImpl#getRequireBoth <em>Require Both</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubscriptionTopicQueryCriteriaImpl extends BackboneElementImpl implements SubscriptionTopicQueryCriteria {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String previous;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String current;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean requireBoth;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getPrevious() {
		return previous;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPrevious(org.hl7.emf.fhir.String newPrevious, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldPrevious = previous;
	 ...
	 */
	@Override
	public void setPrevious(org.hl7.emf.fhir.String newPrevious) {
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getCurrent() {
		return current;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCurrent(org.hl7.emf.fhir.String newCurrent, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldCurrent = current;
		current = newCurrent;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setCurrent(org.hl7.emf.fhir.String newCurrent) {
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getRequireBoth() {
		return requireBoth;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRequireBoth(org.hl7.emf.fhir.Boolean newRequireBoth, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldRequireBoth = requireBoth;
	 ...
	 */
	@Override
	public void setRequireBoth(org.hl7.emf.fhir.Boolean newRequireBoth) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__PREVIOUS:
				setPrevious((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__RESULT_FOR_CREATE:
				setResultForCreate((CriteriaNotExistsBehavior)newValue);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__CURRENT:
				setCurrent((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__RESULT_FOR_DELETE:
				setResultForDelete((CriteriaNotExistsBehavior)newValue);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__REQUIRE_BOTH:
				setRequireBoth((org.hl7.emf.fhir.Boolean)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__PREVIOUS:
				setPrevious((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__RESULT_FOR_CREATE:
				setResultForCreate((CriteriaNotExistsBehavior)null);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__CURRENT:
				setCurrent((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__RESULT_FOR_DELETE:
				setResultForDelete((CriteriaNotExistsBehavior)null);
				return;
			case FhirPackage.SUBSCRIPTION_TOPIC_QUERY_CRITERIA__REQUIRE_BOTH:
				setRequireBoth((org.hl7.emf.fhir.Boolean)null);
				return;
		}
