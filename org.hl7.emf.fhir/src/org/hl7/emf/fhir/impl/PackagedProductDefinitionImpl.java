 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getPackageFor <em>Package For</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getContainedItemQuantity <em>Contained Item Quantity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getLegalStatusOfSupply <em>Legal Status Of Supply</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getMarketingStatus <em>Marketing Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getCopackagedIndicator <em>Copackaged Indicator</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getAttachedDocument <em>Attached Document</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getPackaging <em>Packaging</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PackagedProductDefinitionImpl#getCharacteristic <em>Characteristic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackagedProductDefinitionImpl extends DomainResourceImpl implements PackagedProductDefinition {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean copackagedIndicator;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getCopackagedIndicator() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCopackagedIndicator(org.hl7.emf.fhir.Boolean newCopackagedIndicator, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldCopackagedIndicator = copackagedIndicator;
	 ...
	 */
	@Override
	public void setCopackagedIndicator(org.hl7.emf.fhir.Boolean newCopackagedIndicator) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.PACKAGED_PRODUCT_DEFINITION__MARKETING_STATUS:
				...
				return;
			case FhirPackage.PACKAGED_PRODUCT_DEFINITION__COPACKAGED_INDICATOR:
				setCopackagedIndicator((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.PACKAGED_PRODUCT_DEFINITION__MANUFACTURER:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.PACKAGED_PRODUCT_DEFINITION__MARKETING_STATUS:
				...
				return;
			case FhirPackage.PACKAGED_PRODUCT_DEFINITION__COPACKAGED_INDICATOR:
				setCopackagedIndicator((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.PACKAGED_PRODUCT_DEFINITION__MANUFACTURER:
				getManufacturer().clear();
				return;
