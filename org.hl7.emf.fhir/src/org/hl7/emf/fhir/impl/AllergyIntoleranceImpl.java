 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getClinicalStatus <em>Clinical Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getVerificationStatus <em>Verification Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getCriticality <em>Criticality</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getPatient <em>Patient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getOnsetDateTime <em>Onset Date Time</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getOnsetAge <em>Onset Age</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getOnsetPeriod <em>Onset Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getOnsetRange <em>Onset Range</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getOnsetString <em>Onset String</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getRecordedDate <em>Recorded Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getParticipant <em>Participant</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getLastOccurrence <em>Last Occurrence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getNote <em>Note</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.AllergyIntoleranceImpl#getReaction <em>Reaction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllergyIntoleranceImpl extends DomainResourceImpl implements AllergyIntolerance {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.ALLERGY_INTOLERANCE__PARTICIPANT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.ALLERGY_INTOLERANCE__PARTICIPANT:
				...
				getParticipant().addAll((Collection<? extends AllergyIntoleranceParticipant>)newValue);
				return;
			case FhirPackage.ALLERGY_INTOLERANCE__LAST_OCCURRENCE:
