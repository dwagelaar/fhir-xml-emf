 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getResponse <em>Response</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getReporter <em>Reporter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getPayment <em>Payment</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getPaymentDate <em>Payment Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getPayee <em>Payee</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.PaymentNoticeImpl#getPaymentStatus <em>Payment Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PaymentNoticeImpl extends DomainResourceImpl implements PaymentNotice {
	...
	public NotificationChain basicSetReporter(Reference newReporter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PAYMENT_NOTICE__REPORTER, oldReporter, newReporter);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReporter(Reference newReporter) {
		if (newReporter != reporter) {
			NotificationChain msgs = null;
			if (reporter != null)
				msgs = ((InternalEObject)reporter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PAYMENT_NOTICE__REPORTER, null, msgs);
			if (newReporter != null)
				msgs = ((InternalEObject)newReporter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PAYMENT_NOTICE__REPORTER, null, msgs);
			msgs = basicSetReporter(newReporter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PAYMENT_NOTICE__REPORTER, newReporter, newReporter));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.PAYMENT_NOTICE__REPORTER:
