 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionHandlingImpl#getTemperatureQualifier <em>Temperature Qualifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionHandlingImpl#getTemperatureRange <em>Temperature Range</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionHandlingImpl#getMaxDuration <em>Max Duration</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SpecimenDefinitionHandlingImpl#getInstruction <em>Instruction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecimenDefinitionHandlingImpl extends BackboneElementImpl implements SpecimenDefinitionHandling {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInstruction(Markdown newInstruction, NotificationChain msgs) {
		Markdown oldInstruction = instruction;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SPECIMEN_DEFINITION_HANDLING__MAX_DURATION:
				...
				return;
			case FhirPackage.SPECIMEN_DEFINITION_HANDLING__INSTRUCTION:
				setInstruction((Markdown)newValue);
				return;
		}
