 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationPayloadImpl#getContentAttachment <em>Content Attachment</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationPayloadImpl#getContentReference <em>Content Reference</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.CommunicationPayloadImpl#getContentCodeableConcept <em>Content Codeable Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationPayloadImpl extends BackboneElementImpl implements CommunicationPayload {
	...
	public NotificationChain basicSetContentCodeableConcept(CodeableConcept newContentCodeableConcept, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_CODEABLE_CONCEPT, oldContentCodeableConcept, newContentCodeableConcept);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContentCodeableConcept(CodeableConcept newContentCodeableConcept) {
		if (newContentCodeableConcept != contentCodeableConcept) {
			...
			if (contentCodeableConcept != null)
				msgs = ((InternalEObject)contentCodeableConcept).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_CODEABLE_CONCEPT, null, msgs);
			if (newContentCodeableConcept != null)
				msgs = ((InternalEObject)newContentCodeableConcept).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_CODEABLE_CONCEPT, null, msgs);
			msgs = basicSetContentCodeableConcept(newContentCodeableConcept, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_CODEABLE_CONCEPT, newContentCodeableConcept, newContentCodeableConcept));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_CODEABLE_CONCEPT:
