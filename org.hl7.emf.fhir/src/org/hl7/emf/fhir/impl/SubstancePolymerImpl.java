 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerImpl#getGeometry <em>Geometry</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerImpl#getCopolymerConnectivity <em>Copolymer Connectivity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerImpl#getModification <em>Modification</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerImpl#getMonomerSet <em>Monomer Set</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerImpl#getRepeat <em>Repeat</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstancePolymerImpl extends DomainResourceImpl implements SubstancePolymer {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String modification;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getModification() {
		return modification;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetModification(org.hl7.emf.fhir.String newModification, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldModification = modification;
	 ...
	 */
	@Override
	public void setModification(org.hl7.emf.fhir.String newModification) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.SUBSTANCE_POLYMER__COPOLYMER_CONNECTIVITY:
				...
				return;
			case FhirPackage.SUBSTANCE_POLYMER__MODIFICATION:
				setModification((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.SUBSTANCE_POLYMER__MONOMER_SET:
				getMonomerSet().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.SUBSTANCE_POLYMER__COPOLYMER_CONNECTIVITY:
				...
				return;
			case FhirPackage.SUBSTANCE_POLYMER__MODIFICATION:
				setModification((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.SUBSTANCE_POLYMER__MONOMER_SET:
				getMonomerSet().clear();
				return;
