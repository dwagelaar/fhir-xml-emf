 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerDegreeOfPolymerisationImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerDegreeOfPolymerisationImpl#getAverage <em>Average</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerDegreeOfPolymerisationImpl#getLow <em>Low</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.SubstancePolymerDegreeOfPolymerisationImpl#getHigh <em>High</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstancePolymerDegreeOfPolymerisationImpl extends BackboneElementImpl implements SubstancePolymerDegreeOfPolymerisation {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer average;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer low;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer high;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getAverage() {
		return average;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAverage(org.hl7.emf.fhir.Integer newAverage, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldAverage = average;
		average = newAverage;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setAverage(org.hl7.emf.fhir.Integer newAverage) {
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getLow() {
		return low;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLow(org.hl7.emf.fhir.Integer newLow, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldLow = low;
		low = newLow;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setLow(org.hl7.emf.fhir.Integer newLow) {
		if (newLow != low) {
			NotificationChain msgs = null;
			if (low != null)
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getHigh() {
		return high;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetHigh(org.hl7.emf.fhir.Integer newHigh, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldHigh = high;
		high = newHigh;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setHigh(org.hl7.emf.fhir.Integer newHigh) {
		if (newHigh != high) {
			NotificationChain msgs = null;
			if (high != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.SUBSTANCE_POLYMER_DEGREE_OF_POLYMERISATION__TYPE:
				...
				return;
			case FhirPackage.SUBSTANCE_POLYMER_DEGREE_OF_POLYMERISATION__AVERAGE:
				setAverage((org.hl7.emf.fhir.Integer)newValue);
				return;
			case FhirPackage.SUBSTANCE_POLYMER_DEGREE_OF_POLYMERISATION__LOW:
				setLow((org.hl7.emf.fhir.Integer)newValue);
				return;
			case FhirPackage.SUBSTANCE_POLYMER_DEGREE_OF_POLYMERISATION__HIGH:
				setHigh((org.hl7.emf.fhir.Integer)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.SUBSTANCE_POLYMER_DEGREE_OF_POLYMERISATION__TYPE:
				...
				return;
			case FhirPackage.SUBSTANCE_POLYMER_DEGREE_OF_POLYMERISATION__AVERAGE:
				setAverage((org.hl7.emf.fhir.Integer)null);
				return;
			case FhirPackage.SUBSTANCE_POLYMER_DEGREE_OF_POLYMERISATION__LOW:
				setLow((org.hl7.emf.fhir.Integer)null);
				return;
			case FhirPackage.SUBSTANCE_POLYMER_DEGREE_OF_POLYMERISATION__HIGH:
				setHigh((org.hl7.emf.fhir.Integer)null);
				return;
		}
