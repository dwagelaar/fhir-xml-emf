 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.OperationOutcomeIssueImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OperationOutcomeIssueImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OperationOutcomeIssueImpl#getDetails <em>Details</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OperationOutcomeIssueImpl#getDiagnostics <em>Diagnostics</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OperationOutcomeIssueImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.OperationOutcomeIssueImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationOutcomeIssueImpl extends BackboneElementImpl implements OperationOutcomeIssue {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String diagnostics;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> location;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> expression;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getDiagnostics() {
		return diagnostics;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDiagnostics(org.hl7.emf.fhir.String newDiagnostics, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldDiagnostics = diagnostics;
	 ...
	 */
	@Override
	public void setDiagnostics(org.hl7.emf.fhir.String newDiagnostics) {
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getLocation() {
		if (location == null) {
			location = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.OPERATION_OUTCOME_ISSUE__LOCATION);
		}
		return location;
	}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getExpression() {
		if (expression == null) {
			expression = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.OPERATION_OUTCOME_ISSUE__EXPRESSION);
		}
		return expression;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.OPERATION_OUTCOME_ISSUE__DETAILS:
				...
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__DIAGNOSTICS:
				setDiagnostics((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__LOCATION:
				getLocation().clear();
				getLocation().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__EXPRESSION:
				getExpression().clear();
				getExpression().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.OPERATION_OUTCOME_ISSUE__DETAILS:
				...
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__DIAGNOSTICS:
				setDiagnostics((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.OPERATION_OUTCOME_ISSUE__LOCATION:
				getLocation().clear();
				return;
