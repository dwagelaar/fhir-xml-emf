 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimInsuranceImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimInsuranceImpl#getFocal <em>Focal</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimInsuranceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimInsuranceImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimInsuranceImpl#getBusinessArrangement <em>Business Arrangement</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimInsuranceImpl#getPreAuthRef <em>Pre Auth Ref</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ClaimInsuranceImpl#getClaimResponse <em>Claim Response</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClaimInsuranceImpl extends BackboneElementImpl implements ClaimInsurance {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean focal;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String businessArrangement;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getFocal() {
		return focal;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetFocal(org.hl7.emf.fhir.Boolean newFocal, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldFocal = focal;
		focal = newFocal;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setFocal(org.hl7.emf.fhir.Boolean newFocal) {
		if (newFocal != focal) {
			NotificationChain msgs = null;
			if (focal != null)
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getBusinessArrangement() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBusinessArrangement(org.hl7.emf.fhir.String newBusinessArrangement, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldBusinessArrangement = businessArrangement;
	 ...
	 */
	@Override
	public void setBusinessArrangement(org.hl7.emf.fhir.String newBusinessArrangement) {
	...
	public EList<org.hl7.emf.fhir.String> getPreAuthRef() {
		if (preAuthRef == null) {
			preAuthRef = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.CLAIM_INSURANCE__PRE_AUTH_REF);
		}
		return preAuthRef;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.CLAIM_INSURANCE__SEQUENCE:
				...
				return;
			case FhirPackage.CLAIM_INSURANCE__FOCAL:
				setFocal((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.CLAIM_INSURANCE__IDENTIFIER:
			...
			case FhirPackage.CLAIM_INSURANCE__COVERAGE:
				...
				return;
			case FhirPackage.CLAIM_INSURANCE__BUSINESS_ARRANGEMENT:
				setBusinessArrangement((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.CLAIM_INSURANCE__PRE_AUTH_REF:
				getPreAuthRef().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.CLAIM_INSURANCE__SEQUENCE:
				...
				return;
			case FhirPackage.CLAIM_INSURANCE__FOCAL:
				setFocal((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.CLAIM_INSURANCE__IDENTIFIER:
			...
			case FhirPackage.CLAIM_INSURANCE__COVERAGE:
				...
				return;
			case FhirPackage.CLAIM_INSURANCE__BUSINESS_ARRANGEMENT:
				setBusinessArrangement((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.CLAIM_INSURANCE__PRE_AUTH_REF:
				getPreAuthRef().clear();
				return;
