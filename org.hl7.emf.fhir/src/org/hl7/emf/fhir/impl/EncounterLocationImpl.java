 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.EncounterLocationImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EncounterLocationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EncounterLocationImpl#getForm <em>Form</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EncounterLocationImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EncounterLocationImpl extends BackboneElementImpl implements EncounterLocation {
	...
	public NotificationChain basicSetForm(CodeableConcept newForm, NotificationChain msgs) {
		...
		form = newForm;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.ENCOUNTER_LOCATION__FORM, oldForm, newForm);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setForm(CodeableConcept newForm) {
		if (newForm != form) {
			NotificationChain msgs = null;
			if (form != null)
				msgs = ((InternalEObject)form).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.ENCOUNTER_LOCATION__FORM, null, msgs);
			if (newForm != null)
				msgs = ((InternalEObject)newForm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.ENCOUNTER_LOCATION__FORM, null, msgs);
			msgs = basicSetForm(newForm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.ENCOUNTER_LOCATION__FORM, newForm, newForm));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.ENCOUNTER_LOCATION__FORM:
