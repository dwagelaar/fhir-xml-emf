 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.DeviceDefinitionConformsToImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DeviceDefinitionConformsToImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DeviceDefinitionConformsToImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.DeviceDefinitionConformsToImpl#getSource <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceDefinitionConformsToImpl extends BackboneElementImpl implements DeviceDefinitionConformsTo {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> version;
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getVersion() {
		if (version == null) {
			version = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.DEVICE_DEFINITION_CONFORMS_TO__VERSION);
		}
		return version;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.DEVICE_DEFINITION_CONFORMS_TO__VERSION:
				getVersion().clear();
				getVersion().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.DEVICE_DEFINITION_CONFORMS_TO__SOURCE:
				getSource().clear();
