 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getProvidedBy <em>Provided By</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getOfferedIn <em>Offered In</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getSpecialty <em>Specialty</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getExtraDetails <em>Extra Details</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getPhoto <em>Photo</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getCoverageArea <em>Coverage Area</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getServiceProvisionCode <em>Service Provision Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getEligibility <em>Eligibility</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getProgram <em>Program</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getCharacteristic <em>Characteristic</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getCommunication <em>Communication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getReferralMethod <em>Referral Method</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getAppointmentRequired <em>Appointment Required</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getAvailability <em>Availability</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HealthcareServiceImpl#getEndpoint <em>Endpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HealthcareServiceImpl extends DomainResourceImpl implements HealthcareService {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean appointmentRequired;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getAppointmentRequired() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAppointmentRequired(org.hl7.emf.fhir.Boolean newAppointmentRequired, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldAppointmentRequired = appointmentRequired;
	 ...
	 */
	@Override
	public void setAppointmentRequired(org.hl7.emf.fhir.Boolean newAppointmentRequired) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.HEALTHCARE_SERVICE__REFERRAL_METHOD:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__APPOINTMENT_REQUIRED:
				setAppointmentRequired((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__AVAILABILITY:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.HEALTHCARE_SERVICE__REFERRAL_METHOD:
				...
				return;
			case FhirPackage.HEALTHCARE_SERVICE__APPOINTMENT_REQUIRED:
				setAppointmentRequired((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.HEALTHCARE_SERVICE__AVAILABILITY:
				getAvailability().clear();
				return;
