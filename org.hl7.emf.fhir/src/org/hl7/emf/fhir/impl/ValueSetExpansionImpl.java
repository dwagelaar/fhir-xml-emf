 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ValueSetExpansionImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ValueSetExpansionImpl#getNext <em>Next</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ValueSetExpansionImpl#getTimestamp <em>Timestamp</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ValueSetExpansionImpl#getTotal <em>Total</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ValueSetExpansionImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ValueSetExpansionImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ValueSetExpansionImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ValueSetExpansionImpl#getContains <em>Contains</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueSetExpansionImpl extends BackboneElementImpl implements ValueSetExpansion {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer total;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Integer offset;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNext(Uri newNext, NotificationChain msgs) {
		Uri oldNext = next;
		next = newNext;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.VALUE_SET_EXPANSION__NEXT, oldNext, newNext);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNext(Uri newNext) {
		if (newNext != next) {
			NotificationChain msgs = null;
			if (next != null)
				msgs = ((InternalEObject)next).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.VALUE_SET_EXPANSION__NEXT, null, msgs);
			if (newNext != null)
				msgs = ((InternalEObject)newNext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.VALUE_SET_EXPANSION__NEXT, null, msgs);
			msgs = basicSetNext(newNext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.VALUE_SET_EXPANSION__NEXT, newNext, newNext));
	}
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getTotal() {
		return total;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTotal(org.hl7.emf.fhir.Integer newTotal, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldTotal = total;
		total = newTotal;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setTotal(org.hl7.emf.fhir.Integer newTotal) {
		if (newTotal != total) {
			NotificationChain msgs = null;
			if (total != null)
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Integer getOffset() {
		return offset;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOffset(org.hl7.emf.fhir.Integer newOffset, NotificationChain msgs) {
		org.hl7.emf.fhir.Integer oldOffset = offset;
		offset = newOffset;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setOffset(org.hl7.emf.fhir.Integer newOffset) {
		if (newOffset != offset) {
			NotificationChain msgs = null;
			if (offset != null)
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.VALUE_SET_EXPANSION__NEXT:
			...
			case FhirPackage.VALUE_SET_EXPANSION__PROPERTY:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.VALUE_SET_EXPANSION__IDENTIFIER:
				...
				return;
			case FhirPackage.VALUE_SET_EXPANSION__NEXT:
				setNext((Uri)newValue);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__TIMESTAMP:
				setTimestamp((DateTime)newValue);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__TOTAL:
				setTotal((org.hl7.emf.fhir.Integer)newValue);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__OFFSET:
				setOffset((org.hl7.emf.fhir.Integer)newValue);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__PARAMETER:
				getParameter().clear();
			...
			case FhirPackage.VALUE_SET_EXPANSION__PROPERTY:
				getProperty().clear();
				getProperty().addAll((Collection<? extends ValueSetProperty>)newValue);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__CONTAINS:
				getContains().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.VALUE_SET_EXPANSION__TIMESTAMP:
				...
				return;
			case FhirPackage.VALUE_SET_EXPANSION__TOTAL:
				setTotal((org.hl7.emf.fhir.Integer)null);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__OFFSET:
				setOffset((org.hl7.emf.fhir.Integer)null);
				return;
			case FhirPackage.VALUE_SET_EXPANSION__PARAMETER:
				getParameter().clear();
				return;
