 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getInformationType <em>Information Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getRelatedArtifact <em>Related Artifact</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getFreeToShare <em>Free To Share</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ArtifactAssessmentContentImpl#getComponent <em>Component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtifactAssessmentContentImpl extends BackboneElementImpl implements ArtifactAssessmentContent {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean freeToShare;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getFreeToShare() {
		return freeToShare;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetFreeToShare(org.hl7.emf.fhir.Boolean newFreeToShare, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldFreeToShare = freeToShare;
	 ...
	 */
	@Override
	public void setFreeToShare(org.hl7.emf.fhir.Boolean newFreeToShare) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.ARTIFACT_ASSESSMENT_CONTENT__RELATED_ARTIFACT:
				...
				return;
			case FhirPackage.ARTIFACT_ASSESSMENT_CONTENT__FREE_TO_SHARE:
				setFreeToShare((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.ARTIFACT_ASSESSMENT_CONTENT__COMPONENT:
				getComponent().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.ARTIFACT_ASSESSMENT_CONTENT__RELATED_ARTIFACT:
				...
				return;
			case FhirPackage.ARTIFACT_ASSESSMENT_CONTENT__FREE_TO_SHARE:
				setFreeToShare((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.ARTIFACT_ASSESSMENT_CONTENT__COMPONENT:
				getComponent().clear();
				return;
