 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.TestReportAssertImpl#getResult <em>Result</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TestReportAssertImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TestReportAssertImpl#getDetail <em>Detail</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TestReportAssertImpl#getRequirement <em>Requirement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestReportAssertImpl extends BackboneElementImpl implements TestReportAssert {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String detail;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getDetail() {
		return detail;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDetail(org.hl7.emf.fhir.String newDetail, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldDetail = detail;
		detail = newDetail;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setDetail(org.hl7.emf.fhir.String newDetail) {
		if (newDetail != detail) {
			NotificationChain msgs = null;
			if (detail != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.TEST_REPORT_ASSERT__MESSAGE:
				...
				return;
			case FhirPackage.TEST_REPORT_ASSERT__DETAIL:
				setDetail((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.TEST_REPORT_ASSERT__REQUIREMENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.TEST_REPORT_ASSERT__MESSAGE:
				...
				return;
			case FhirPackage.TEST_REPORT_ASSERT__DETAIL:
				setDetail((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.TEST_REPORT_ASSERT__REQUIREMENT:
				getRequirement().clear();
				return;
