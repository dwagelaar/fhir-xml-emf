 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getBasedOn <em>Based On</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getPartOf <em>Part Of</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getNotPerformedReason <em>Not Performed Reason</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getStatusChanged <em>Status Changed</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getMedication <em>Medication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getSupportingInformation <em>Supporting Information</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getAuthorizingPrescription <em>Authorizing Prescription</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getDaysSupply <em>Days Supply</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getRecorded <em>Recorded</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getWhenPrepared <em>When Prepared</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getWhenHandedOver <em>When Handed Over</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getReceiver <em>Receiver</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getNote <em>Note</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getRenderedDosageInstruction <em>Rendered Dosage Instruction</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getDosageInstruction <em>Dosage Instruction</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getSubstitution <em>Substitution</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationDispenseImpl#getEventHistory <em>Event History</em>}</li>
 * </ul>
 *
 * @generated
 */
