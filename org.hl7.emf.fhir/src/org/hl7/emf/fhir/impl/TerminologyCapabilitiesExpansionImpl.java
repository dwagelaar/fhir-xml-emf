 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesExpansionImpl#getHierarchical <em>Hierarchical</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesExpansionImpl#getPaging <em>Paging</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesExpansionImpl#getIncomplete <em>Incomplete</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesExpansionImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.TerminologyCapabilitiesExpansionImpl#getTextFilter <em>Text Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TerminologyCapabilitiesExpansionImpl extends BackboneElementImpl implements TerminologyCapabilitiesExpansion {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean hierarchical;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean paging;
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean incomplete;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getHierarchical() {
		return hierarchical;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetHierarchical(org.hl7.emf.fhir.Boolean newHierarchical, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldHierarchical = hierarchical;
	 ...
	 */
	@Override
	public void setHierarchical(org.hl7.emf.fhir.Boolean newHierarchical) {
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getPaging() {
		return paging;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPaging(org.hl7.emf.fhir.Boolean newPaging, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldPaging = paging;
		paging = newPaging;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setPaging(org.hl7.emf.fhir.Boolean newPaging) {
		if (newPaging != paging) {
			NotificationChain msgs = null;
			if (paging != null)
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getIncomplete() {
		return incomplete;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIncomplete(org.hl7.emf.fhir.Boolean newIncomplete, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldIncomplete = incomplete;
	 ...
	 */
	@Override
	public void setIncomplete(org.hl7.emf.fhir.Boolean newIncomplete) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__HIERARCHICAL:
				setHierarchical((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__PAGING:
				setPaging((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__INCOMPLETE:
				setIncomplete((org.hl7.emf.fhir.Boolean)newValue);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__PARAMETER:
				getParameter().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__HIERARCHICAL:
				setHierarchical((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__PAGING:
				setPaging((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__INCOMPLETE:
				setIncomplete((org.hl7.emf.fhir.Boolean)null);
				return;
			case FhirPackage.TERMINOLOGY_CAPABILITIES_EXPANSION__PARAMETER:
				getParameter().clear();
				return;
