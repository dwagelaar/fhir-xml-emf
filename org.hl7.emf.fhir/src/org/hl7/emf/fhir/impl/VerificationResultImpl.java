 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getTargetLocation <em>Target Location</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getNeed <em>Need</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getStatusDate <em>Status Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getValidationType <em>Validation Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getValidationProcess <em>Validation Process</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getLastPerformed <em>Last Performed</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getNextScheduled <em>Next Scheduled</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getFailureAction <em>Failure Action</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getPrimarySource <em>Primary Source</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getAttestation <em>Attestation</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.VerificationResultImpl#getValidator <em>Validator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VerificationResultImpl extends DomainResourceImpl implements VerificationResult {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> targetLocation;
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getTargetLocation() {
		if (targetLocation == null) {
			targetLocation = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.VERIFICATION_RESULT__TARGET_LOCATION);
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStatus(VerificationResultStatus newStatus, NotificationChain msgs) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.VERIFICATION_RESULT__TARGET_LOCATION:
				...
				getTargetLocation().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.VERIFICATION_RESULT__NEED:
