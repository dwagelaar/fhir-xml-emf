 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getCareTeamSequence <em>Care Team Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getDiagnosisSequence <em>Diagnosis Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getProcedureSequence <em>Procedure Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getInformationSequence <em>Information Sequence</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getTraceNumber <em>Trace Number</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getRevenue <em>Revenue</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getProductOrService <em>Product Or Service</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getProductOrServiceEnd <em>Product Or Service End</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getModifier <em>Modifier</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getProgramCode <em>Program Code</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getServicedDate <em>Serviced Date</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getServicedPeriod <em>Serviced Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getLocationCodeableConcept <em>Location Codeable Concept</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getLocationAddress <em>Location Address</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getLocationReference <em>Location Reference</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getPatientPaid <em>Patient Paid</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getTax <em>Tax</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getNet <em>Net</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getUdi <em>Udi</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getBodySite <em>Body Site</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getNoteNumber <em>Note Number</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getReviewOutcome <em>Review Outcome</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getAdjudication <em>Adjudication</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.ExplanationOfBenefitItemImpl#getDetail <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplanationOfBenefitItemImpl extends BackboneElementImpl implements ExplanationOfBenefitItem {
	...
	public EList<Identifier> getTraceNumber() {
		if (traceNumber == null) {
			traceNumber = new EObjectContainmentEList<Identifier>(Identifier.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__TRACE_NUMBER);
		}
		return traceNumber;
	}
	...
	public NotificationChain basicSetProductOrServiceEnd(CodeableConcept newProductOrServiceEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PRODUCT_OR_SERVICE_END, oldProductOrServiceEnd, newProductOrServiceEnd);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProductOrServiceEnd(CodeableConcept newProductOrServiceEnd) {
		if (newProductOrServiceEnd != productOrServiceEnd) {
			...
			if (productOrServiceEnd != null)
				msgs = ((InternalEObject)productOrServiceEnd).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PRODUCT_OR_SERVICE_END, null, msgs);
			if (newProductOrServiceEnd != null)
				msgs = ((InternalEObject)newProductOrServiceEnd).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PRODUCT_OR_SERVICE_END, null, msgs);
			msgs = basicSetProductOrServiceEnd(newProductOrServiceEnd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PRODUCT_OR_SERVICE_END, newProductOrServiceEnd, newProductOrServiceEnd));
	}
	...
	public EList<Reference> getRequest() {
		if (request == null) {
			request = new EObjectContainmentEList<Reference>(Reference.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__REQUEST);
		}
		return request;
	}
	...
	public NotificationChain basicSetPatientPaid(Money newPatientPaid, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PATIENT_PAID, oldPatientPaid, newPatientPaid);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPatientPaid(Money newPatientPaid) {
		if (newPatientPaid != patientPaid) {
			NotificationChain msgs = null;
			if (patientPaid != null)
				msgs = ((InternalEObject)patientPaid).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PATIENT_PAID, null, msgs);
			if (newPatientPaid != null)
				msgs = ((InternalEObject)newPatientPaid).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PATIENT_PAID, null, msgs);
			msgs = basicSetPatientPaid(newPatientPaid, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PATIENT_PAID, newPatientPaid, newPatientPaid));
	}
	...
	public NotificationChain basicSetTax(Money newTax, NotificationChain msgs) {
		...
		tax = newTax;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__TAX, oldTax, newTax);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTax(Money newTax) {
		if (newTax != tax) {
			NotificationChain msgs = null;
			if (tax != null)
				msgs = ((InternalEObject)tax).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__TAX, null, msgs);
			if (newTax != null)
				msgs = ((InternalEObject)newTax).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__TAX, null, msgs);
			msgs = basicSetTax(newTax, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__TAX, newTax, newTax));
	}
	...
	public EList<ExplanationOfBenefitBodySite> getBodySite() {
		if (bodySite == null) {
			bodySite = new EObjectContainmentEList<ExplanationOfBenefitBodySite>(ExplanationOfBenefitBodySite.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__BODY_SITE);
		}
		return bodySite;
	}
	...
	public NotificationChain basicSetReviewOutcome(ExplanationOfBenefitReviewOutcome newReviewOutcome, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__REVIEW_OUTCOME, oldReviewOutcome, newReviewOutcome);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReviewOutcome(ExplanationOfBenefitReviewOutcome newReviewOutcome) {
		if (newReviewOutcome != reviewOutcome) {
			...
			if (reviewOutcome != null)
				msgs = ((InternalEObject)reviewOutcome).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__REVIEW_OUTCOME, null, msgs);
			if (newReviewOutcome != null)
				msgs = ((InternalEObject)newReviewOutcome).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__REVIEW_OUTCOME, null, msgs);
			msgs = basicSetReviewOutcome(newReviewOutcome, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__REVIEW_OUTCOME, newReviewOutcome, newReviewOutcome));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__TRACE_NUMBER:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PRODUCT_OR_SERVICE_END:
				return basicSetProductOrServiceEnd(null, msgs);
			case FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__REQUEST:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__PATIENT_PAID:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__TAX:
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__REVIEW_OUTCOME:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__BODY_SITE:
				getBodySite().clear();
				getBodySite().addAll((Collection<? extends ExplanationOfBenefitBodySite>)newValue);
				return;
			case FhirPackage.EXPLANATION_OF_BENEFIT_ITEM__ENCOUNTER:
				getEncounter().clear();
