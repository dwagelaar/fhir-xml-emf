 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.HumanNameImpl#getUse <em>Use</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HumanNameImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HumanNameImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HumanNameImpl#getGiven <em>Given</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HumanNameImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HumanNameImpl#getSuffix <em>Suffix</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.HumanNameImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HumanNameImpl extends DataTypeImpl implements HumanName {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String family;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> given;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> prefix;
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.emf.fhir.String> suffix;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getFamily() {
		return family;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetFamily(org.hl7.emf.fhir.String newFamily, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldFamily = family;
		family = newFamily;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setFamily(org.hl7.emf.fhir.String newFamily) {
		if (newFamily != family) {
			NotificationChain msgs = null;
			if (family != null)
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getGiven() {
		if (given == null) {
			given = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.HUMAN_NAME__GIVEN);
		}
		return given;
	}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getPrefix() {
		if (prefix == null) {
			prefix = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.HUMAN_NAME__PREFIX);
		}
		return prefix;
	}
	 ...
	 */
	@Override
	public EList<org.hl7.emf.fhir.String> getSuffix() {
		if (suffix == null) {
			suffix = new EObjectContainmentEList<org.hl7.emf.fhir.String>(org.hl7.emf.fhir.String.class, this, FhirPackage.HUMAN_NAME__SUFFIX);
		}
		return suffix;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.HUMAN_NAME__TEXT:
				...
				return;
			case FhirPackage.HUMAN_NAME__FAMILY:
				setFamily((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.HUMAN_NAME__GIVEN:
				getGiven().clear();
				getGiven().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.HUMAN_NAME__PREFIX:
				getPrefix().clear();
				getPrefix().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.HUMAN_NAME__SUFFIX:
				getSuffix().clear();
				getSuffix().addAll((Collection<? extends org.hl7.emf.fhir.String>)newValue);
				return;
			case FhirPackage.HUMAN_NAME__PERIOD:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FhirPackage.HUMAN_NAME__TEXT:
				...
				return;
			case FhirPackage.HUMAN_NAME__FAMILY:
				setFamily((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.HUMAN_NAME__GIVEN:
				getGiven().clear();
				return;
