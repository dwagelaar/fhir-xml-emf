 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.InsurancePlanBenefitImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InsurancePlanBenefitImpl#getRequirement <em>Requirement</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.InsurancePlanBenefitImpl#getLimit <em>Limit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InsurancePlanBenefitImpl extends BackboneElementImpl implements InsurancePlanBenefit {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.String requirement;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.String getRequirement() {
		return requirement;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRequirement(org.hl7.emf.fhir.String newRequirement, NotificationChain msgs) {
		org.hl7.emf.fhir.String oldRequirement = requirement;
	 ...
	 */
	@Override
	public void setRequirement(org.hl7.emf.fhir.String newRequirement) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.INSURANCE_PLAN_BENEFIT__TYPE:
				...
				return;
			case FhirPackage.INSURANCE_PLAN_BENEFIT__REQUIREMENT:
				setRequirement((org.hl7.emf.fhir.String)newValue);
				return;
			case FhirPackage.INSURANCE_PLAN_BENEFIT__LIMIT:
				getLimit().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.INSURANCE_PLAN_BENEFIT__TYPE:
				...
				return;
			case FhirPackage.INSURANCE_PLAN_BENEFIT__REQUIREMENT:
				setRequirement((org.hl7.emf.fhir.String)null);
				return;
			case FhirPackage.INSURANCE_PLAN_BENEFIT__LIMIT:
				getLimit().clear();
				return;
