 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationKnowledgeSubstitutionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.MedicationKnowledgeSubstitutionImpl#getAllowed <em>Allowed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicationKnowledgeSubstitutionImpl extends BackboneElementImpl implements MedicationKnowledgeSubstitution {
	 ...
	 * @ordered
	 */
	protected org.hl7.emf.fhir.Boolean allowed;
	 ...
	 */
	@Override
	public org.hl7.emf.fhir.Boolean getAllowed() {
		return allowed;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAllowed(org.hl7.emf.fhir.Boolean newAllowed, NotificationChain msgs) {
		org.hl7.emf.fhir.Boolean oldAllowed = allowed;
		allowed = newAllowed;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setAllowed(org.hl7.emf.fhir.Boolean newAllowed) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.MEDICATION_KNOWLEDGE_SUBSTITUTION__TYPE:
				...
				return;
			case FhirPackage.MEDICATION_KNOWLEDGE_SUBSTITUTION__ALLOWED:
				setAllowed((org.hl7.emf.fhir.Boolean)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.MEDICATION_KNOWLEDGE_SUBSTITUTION__TYPE:
				...
				return;
			case FhirPackage.MEDICATION_KNOWLEDGE_SUBSTITUTION__ALLOWED:
				setAllowed((org.hl7.emf.fhir.Boolean)null);
				return;
		}
