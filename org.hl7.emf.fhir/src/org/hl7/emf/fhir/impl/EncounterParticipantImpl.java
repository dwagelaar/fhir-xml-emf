 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.emf.fhir.impl.EncounterParticipantImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EncounterParticipantImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link org.hl7.emf.fhir.impl.EncounterParticipantImpl#getActor <em>Actor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EncounterParticipantImpl extends BackboneElementImpl implements EncounterParticipant {
	...
	public NotificationChain basicSetActor(Reference newActor, NotificationChain msgs) {
		...
		actor = newActor;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.ENCOUNTER_PARTICIPANT__ACTOR, oldActor, newActor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setActor(Reference newActor) {
		if (newActor != actor) {
			NotificationChain msgs = null;
			if (actor != null)
				msgs = ((InternalEObject)actor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.ENCOUNTER_PARTICIPANT__ACTOR, null, msgs);
			if (newActor != null)
				msgs = ((InternalEObject)newActor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.ENCOUNTER_PARTICIPANT__ACTOR, null, msgs);
			msgs = basicSetActor(newActor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.ENCOUNTER_PARTICIPANT__ACTOR, newActor, newActor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.ENCOUNTER_PARTICIPANT__ACTOR:
